...
public class T02 extends RefactoringTest {
	...
	protected void doExecuteRefactoring() {
		...
		bot.activateShellWithName("Change Method Signature");
	...
	protected void doLogsShouldBeCorrect() throws Exception {
		...
		printMessage("If you perform the steps of this test manually, you'll hit the cancel button just once. But, the hitting the cancel button will be recorded twice in the refactoring descriptors generated by CodingSpectator.");
	}
