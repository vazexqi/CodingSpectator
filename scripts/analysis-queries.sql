...
* *DSV_COL_DELIM = ,
* *DSV_ROW_DELIM = \n
* *DSV_TARGET_FILE=ChangeSizePerRefactoring.csv

\x SELECT CASE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" WHEN 'org.eclipse.jdt.ui.rename.compilationunit' THEN  'org.eclipse.jdt.ui.rename.class' WHEN 'org.eclipse.jdt.ui.rename.type' THEN 'org.eclipse.jdt.ui.rename.class' ELSE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" END AS "R", "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT" AS "F", "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT" AS "L" FROM "PUBLIC"."REFACTORING_CHANGE_SIZE" WHERE IS_JAVA_REFACTORING("PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID") ORDER BY CASE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" WHEN 'org.eclipse.jdt.ui.rename.compilationunit' THEN 'org.eclipse.jdt.ui.rename.class' WHEN 'org.eclipse.jdt.ui.rename.type' THEN 'org.eclipse.jdt.ui.rename.class' ELSE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" END;

* *DSV_COL_DELIM = ,
* *DSV_ROW_DELIM = \n
* *DSV_TARGET_FILE=CountPerChangeSize.csv

\x SELECT "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT" AS "F", "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT" AS "L", COUNT(*) AS "C" FROM "PUBLIC"."REFACTORING_CHANGE_SIZE" WHERE IS_JAVA_REFACTORING("PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID") GROUP BY "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT", "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT";
