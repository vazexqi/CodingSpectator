...
-- Calculating intersection of CodingSpectator and CodingTracker data

\i intersection-queries.sql
...
CREATE TABLE "PUBLIC"."PER_REFACTORING_ID" (
  ...
  "P_CANCELED_GIVEN_INVOCATION" NUMERIC(3,2),
  "P_UNDONE_OR_CANCELED_GIVEN_INVOCATION" NUMERIC(3,2),
...
INSERT INTO "PUBLIC"."PER_REFACTORING_ID" (
  ...
  "P_CANCELED_GIVEN_INVOCATION",
  "P_UNDONE_OR_CANCELED_GIVEN_INVOCATION",
...
CASE (COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) + COUNT(NULLIF(IS_CODINGSPECTATOR_PERFORMED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)))
WHEN 0 THEN NULL
ELSE
CAST(COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) AS REAL) /
(COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) + COUNT(NULLIF(IS_CODINGSPECTATOR_PERFORMED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)))
END AS P_CANCELED_GIVEN_INVOCATION,

CASE (COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) + COUNT(NULLIF(IS_CODINGSPECTATOR_PERFORMED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)))
WHEN 0 THEN NULL
ELSE
(CAST(COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) AS REAL) + (SELECT "T"."UNDONE_COUNT" FROM "PUBLIC"."UNDONE_CODINGSPECTATOR_COUNT" AS "T" WHERE "T"
."REFACTORING_ID" = "PUBLIC"."ALL_DATA"."id")) /
(COUNT(NULLIF(IS_CODINGSPECTATOR_CANCELLED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)) + COUNT(NULLIF(IS_CODINGSPECTATOR_PERFORMED("PUBLIC"."ALL_DATA"."recorder", "PUBLIC"."ALL_DATA"."refactoring kind"), FALSE)))
END AS "P_UNDONE_OR_CANCELED_GIVEN_INVOCATION",
