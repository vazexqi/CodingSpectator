...
* *DSV_TARGET_TABLE = "PUBLIC"."REFACTORING_CHANGE_INTENSITY"

DROP TABLE "PUBLIC"."REFACTORING_CHANGE_INTENSITY" IF EXISTS;

CREATE TABLE "PUBLIC"."REFACTORING_CHANGE_INTENSITY" (
"USERNAME" VARCHAR(10),
...
* *DSV_COL_DELIM = ,
* *DSV_ROW_DELIM = \n
* *DSV_TARGET_FILE=CodeIntensityPerRefactoringID.csv

\x SELECT "PUBLIC"."REFACTORING_CHANGE_INTENSITY"."REFACTORING_ID" AS "REFACTORING_ID", COUNT("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."USERNAME") AS "INVOCATION_COUNT", AVG(CONVERT("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_FILES_COUNT",SQL_FLOAT)) AS "AVG_AFFECTED_FILES_FLOAT", AVG(CONVERT("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_LINES_COUNT",SQL_FLOAT)) AS "AVG_AFFECTED_LINES_FLOAT", AVG("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_FILES_COUNT") AS "AVG_AFFECTED_FILES_INT", AVG("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_LINES_COUNT") AS "AVG_AFFECTED_LINES_INT", SUM("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_FILES_COUNT") AS "SUM_AFFECTED_FILES", SUM("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."AFFECTED_LINES_COUNT") AS "SUM_AFFECTED_LINES" FROM "PUBLIC"."REFACTORING_CHANGE_INTENSITY" WHERE IS_JAVA_REFACTORING("PUBLIC"."REFACTORING_CHANGE_INTENSITY"."REFACTORING_ID") GROUP BY "PUBLIC"."REFACTORING_CHANGE_INTENSITY"."REFACTORING_ID" ORDER BY "PUBLIC"."REFACTORING_CHANGE_INTENSITY"."REFACTORING_ID";
