...
DROP TABLE "PUBLIC"."REFACTORING_MESSAGES_DUE_TO_NAME_CONFLICTS_STATISTICS" IF EXISTS;

CREATE TABLE "PUBLIC"."REFACTORING_MESSAGES_DUE_TO_NAME_CONFLICTS_STATISTICS" (
  "NUMBER_OF_INVOCATIONS_WITH_NAME_CONFLICT" INT,
  "NUMBER_OF_AFFECTED_PARTICIPANTS" INT,
  "NUMBER_OF_PERFORMED" INT,
  "NUMBER_OF_CANCELED" INT
);

INSERT INTO "PUBLIC"."REFACTORING_MESSAGES_DUE_TO_NAME_CONFLICTS_STATISTICS" (
  "NUMBER_OF_INVOCATIONS_WITH_NAME_CONFLICT",
  "NUMBER_OF_AFFECTED_PARTICIPANTS",
  "NUMBER_OF_PERFORMED",
  "NUMBER_OF_CANCELED"
)
SELECT
COUNT(DISTINCT("TIMESTAMP")) AS "NUMBER_OF_INVOCATIONS_WITH_NAME_CONFLICT",
COUNT(DISTINCT("USERNAME")) AS "NUMBER_OF_AFFECTED_PARTICIPANTS",
SUM("NUMBER_OF_PERFORMED") AS "NUMBER_OF_PERFORMED",
SUM("NUMBER_OF_CANCELED") AS "NUMBER_OF_CANCELED"
FROM "PUBLIC"."REFACTORING_MESSAGES_DUE_TO_NAME_CONFLICTS" "T";

* *DSV_COL_DELIM=,
* *DSV_ROW_DELIM=\n
* *DSV_TARGET_FILE=RefactoringMessagesDueToNameConflictsStatistics.csv

\x SELECT * FROM "PUBLIC"."REFACTORING_MESSAGES_DUE_TO_NAME_CONFLICTS_STATISTICS"
