...
IS_CODINGSPECTATOR_PERFORMED("T"."recorder", "T"."refactoring kind") AND
...
AVG(CONVERT("PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT",
SQL_FLOAT)) AS "AVG_AFFECTED_FILES_FLOAT",

AVG(CONVERT("PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT",
SQL_FLOAT)) AS "AVG_AFFECTED_LINES_FLOAT",

AVG("PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT") AS
"AVG_AFFECTED_FILES_INT",

AVG("PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT") AS
"AVG_AFFECTED_LINES_INT",
...
ORDER BY "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID";
...
"PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT" AS
"AFFECTED_FILES_COUNT",

"PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_LINES_COUNT" AS "L",
...
GROUP BY "PUBLIC"."REFACTORING_CHANGE_SIZE"."AFFECTED_FILES_COUNT",
...
-- List the affected number of lines and files and configuration time of every
-- refactoring.  Use the script refactoring-size-configuration-analysis.sql to
-- combine the configuration data and refactoring size data
...
CASE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID"
...
ELSE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" END AS
"REFACTORING_ID",

COUNT(*) AS "C" FROM "PUBLIC"."REFACTORING_CHANGE_SIZE"
...
ELSE "PUBLIC"."REFACTORING_CHANGE_SIZE"."REFACTORING_ID" END
