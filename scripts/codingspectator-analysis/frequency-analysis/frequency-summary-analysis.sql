...
VALUES (
  ...
  'TOTAL_CODINGTRACKER_UNDONE_COUNT',

  (SELECT SUM("CODINGTRACKER_UNDONE_COUNT") FROM
"PUBLIC"."PER_REFACTORING_ID_SUMMARY" "T" WHERE
IS_REFACTORING_ID_IN_ICSE2012_PAPER("T"."REFACTORING_ID") AND
IS_REFACTORING_ID_SUPPORTED_BY_CS("T"."REFACTORING_ID")),
...
VALUES (
  ...
  'TOTAL_CODINGTRACKER_REDONE_COUNT',

  (SELECT SUM("CODINGTRACKER_REDONE_COUNT") FROM
"PUBLIC"."PER_REFACTORING_ID_SUMMARY" "T" WHERE
IS_REFACTORING_ID_IN_ICSE2012_PAPER("T"."REFACTORING_ID") AND
IS_REFACTORING_ID_SUPPORTED_BY_CS("T"."REFACTORING_ID")),
...
VALUES (
  ...
  'TOTAL_CODINGSPECTATOR_UNAVAILABLE_COUNT',

  (SELECT SUM("T"."CODINGSPECTATOR_UNAVAILABLE_COUNT") FROM
"PUBLIC"."PER_REFACTORING_ID_SUMMARY" "T" WHERE
IS_REFACTORING_ID_IN_ICSE2012_PAPER("T"."REFACTORING_ID") AND
IS_REFACTORING_ID_SUPPORTED_BY_CS("T"."REFACTORING_ID")),
