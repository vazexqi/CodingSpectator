...
# proper closures for correlated subqueries.
...
"CS"."REFACTORING_ID" AS CS_REFACTORING_ID,

"CS"."REFACTORING_USERNAME" AS CS_REFACTORING_USERNAME,

"CS"."REFACTORING_TIMESTAMP" AS CS_REFACTORING_TIMESTAMP,

"CT"."REFACTORING_TIMESTAMP" AS CT_REFACTORING_TIMESTAMP,

"CS"."REFACTORING_WORKSPACE" AS CS_REFACTORING_WORKSPACE

FROM (SELECT "CT_UNDONE"."id" AS REFACTORING_ID,

"CT_UNDONE"."timestamp" AS REFACTORING_TIMESTAMP,

"CT_UNDONE"."username" AS REFACTORING_USERNAME,

"CT_UNDONE"."workspace ID" REFACTORING_WORKSPACE

FROM"PUBLIC"."ALL_DATA" AS "CT_UNDONE"

WHERE "CT_UNDONE"."id" = '__REPLACE_ME__' AND "CT_UNDONE"."username" LIKE
'cs-___' AND IS_CODINGTRACKER_UNDONE("CT_UNDONE"."recorder",
"CT_UNDONE"."refactoring kind")

ORDER BY "CT_UNDONE"."timestamp") AS "CT" INNER JOIN

(SELECT "CS_PERFORMED"."id" AS REFACTORING_ID,

"CS_PERFORMED"."timestamp" AS REFACTORING_TIMESTAMP,

"CS_PERFORMED"."username" AS REFACTORING_USERNAME,

"CS_PERFORMED"."workspace ID" REFACTORING_WORKSPACE

FROM "PUBLIC"."ALL_DATA" AS "CS_PERFORMED"

WHERE "CS_PERFORMED"."id" = '__REPLACE_ME__' AND "CS_PERFORMED"."username" LIKE
'cs-___' AND IS_CODINGSPECTATOR_PERFORMED("CS_PERFORMED"."recorder",
"CS_PERFORMED"."refactoring kind")

ORDER BY "CS_PERFORMED"."timestamp") AS "CS" ON "CT"."REFACTORING_USERNAME" =
"CS"."REFACTORING_USERNAME" AND "CT"."REFACTORING_WORKSPACE" =
"CS"."REFACTORING_WORKSPACE" AND ABS("CT"."REFACTORING_TIMESTAMP" -
"CS"."REFACTORING_TIMESTAMP") < 1000))

FROM (SELECT DISTINCT "PUBLIC"."ALL_DATA"."id" as "id"

FROM "PUBLIC"."ALL_DATA" WHERE IS_JAVA_REFACTORING("PUBLIC"."ALL_DATA"."id")
AND "PUBLIC"."ALL_DATA"."username" LIKE 'cs-___') as "T" WHERE "T"."id" =
'__REPLACE_ME__';
TEMPLATE
