...
DROP TABLE "PUBLIC"."REFACTORING_MESSAGES_SUMMARY" IF EXISTS;

CREATE TABLE "PUBLIC"."REFACTORING_MESSAGES_SUMMARY" (
...
INSERT INTO "PUBLIC"."REFACTORING_MESSAGES_SUMMARY" (
  "MESSAGE_PATTERN_ID",
  "KIND",
  "MESSAGE_PATTERN",
...
* *DSV_COL_DELIM=|
* *DSV_ROW_DELIM=\n
* *DSV_TARGET_FILE=RefactoringMessagesSummary.csv

\x "PUBLIC"."REFACTORING_MESSAGES_SUMMARY"
