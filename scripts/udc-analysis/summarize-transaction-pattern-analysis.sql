...
--FIXME: Optimize the following subquery by creating the proper indices.

(SELECT COUNT(*) FROM "PUBLIC"."TRANSACTION_DESCRIPTIONS" "TD" WHERE
"TD"."TRANSACTION_IDENTIFIER" IN (SELECT "TRANSACTION_IDENTIFIER" FROM
"PUBLIC"."DETAILED_TRANSACTIONS" "DT2" WHERE
"DT2"."TRANSACTION_PATTERN_IDENTIFIER" =
