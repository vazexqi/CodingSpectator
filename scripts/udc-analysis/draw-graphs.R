...
plot(x = X, y = Y, type = "b", log = "y", xlab = "Number of Different Kinds of Refactorings Used", ylab = "Number of Programmers (log-scale)", main = "Diversity of Refactorings Used by Programmers", xaxt = "n", yaxt = "n")
...
plot(x = X, y = Z, type = "b", xlab = "Maximum Number of Different Kinds of Refactorings Used", ylab = "Percentage of Programmers", main = "Diversity of Refactorings Used by Programmers", xaxt = "n", yaxt = "n")
axis(1, at = X, labels = X)
