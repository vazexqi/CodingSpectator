...
public class RenameSupport {
	 ...
	 * the refactoring can be executed. It may still fail while performing the exhaustive
	 * precondition checking done inside the methods <code>openDialog</code> or <code>perform</code>
	 * .
	 * 
	 ...
	 *         <code>false</code> if it has been canceled or if an error has happened during initial
	 *         conditions checking.
	 * 
	 ...
	 * @param newName the method's new name. <code>null</code> is a valid value indicating that no
	 *            new name is provided.
	 * @param flags flags controlling additional parameters. Valid flags are
	 *            <code>UPDATE_REFERENCES</code> or <code>NONE</code>.
	 * @return the {@link RenameSupport}.
	 ...
	 * @param newName the field's new name. <code>null</code> is a valid value indicating that no
	 *            new name is provided.
	 * @param flags flags controlling additional parameters. Valid flags are
	 ...
	 * @param newName the parameter's new name. <code>null</code> is a valid value indicating that
