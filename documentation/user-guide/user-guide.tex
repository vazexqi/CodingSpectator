...
\warnnote{You should both select the check box and press the \uiref{OK} button
to accept our certificate. If you press the \uiref{OK} button without selecting
the check box on the dialog, Eclipse terminates the installation of \codspec\
silently.}
