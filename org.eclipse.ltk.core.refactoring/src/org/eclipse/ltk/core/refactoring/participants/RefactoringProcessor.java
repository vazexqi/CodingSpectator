...
public abstract class RefactoringProcessor extends PlatformObject {
	 ...
	 * depend on the concrete refactoring processor. For example a processor responsible for
	 * renaming Java methods returns the method to be renamed via this call.
	 * 
	...
	/**
	 * Returns the unique identifier of the refactoring processor. The identifier must not be
	 * <code>null</code>.
	 * 
	...
	/**
	 * Returns a human readable name. The name will be displayed to users. The name must not be
	 * <code>null</code>.
	 * 
	...
	/**
	 * Checks whether the processor is applicable to the elements to be refactored or not. If
	 * <code> false</code> is returned the processor is interpreted to be unusable.
	 * 
	 * @return <code>true</code> if the processor is applicable to the elements; otherwise
	 ...
	 * <p>
	 * The refactoring using this processor is considered as not being executable if the returned
	...
	/**
	 * Additional hook allowing processors to add changes to the set of workspace modifications
	 * after all participant changes have been created.
	 * 
