...
public class UpdateOperationSequenceFormat extends CodingTrackerTest {
	...
	private final String updatedFilePath= "C:/Documents and Settings/Stanislav/CodingSpectator/edu.illinois.codingspectator.codingtracker.tests/test-files/11/codechanges.txt";
