...
/**
 * Compares two Resources and returns flags describing how they have changed, for use in computing
 * deltas. Implementation note: rather than defining a partial order as specified by IComparator,
 * the compare operation returns a set of flags instead. The delta computation only cares whether
 * the comparison is zero (equal) or non-zero (not equal).
 */
public class ResourceComparator implements IElementComparator, ICoreConstants {
	...
	/**
	 * Boolean indicating whether or not this comparator is to be used for a notification. (as
	 * opposed to a build) Notifications include extra information like marker and sync info
	 * changes.
	 */
	private boolean notification;

	/**
	 * Boolean indicating whether or not this comparator is to be used for snapshot. Snapshots care
	 * about extra information such as the used bit.
	 */
	private boolean save;

	/**
	 * Returns a comparator which compares resource infos, suitable for computing save and snapshot
	 * deltas.
	 */
