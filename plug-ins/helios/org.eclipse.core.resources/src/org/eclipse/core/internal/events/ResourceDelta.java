...
/**
 * Concrete implementation of the IResourceDelta interface. Each ResourceDelta object represents
 * changes that have occurred between two states of the resource tree.
 */
public class ResourceDelta extends PlatformObject implements IResourceDelta {
	...
	/**
	 * Delta information on moves and on marker deltas can only be computed after the delta has been
	 * built. This method fixes up the delta to accurately reflect moves (setting MOVED_FROM and
	 * MOVED_TO), and marker changes on added and removed resources.
	 */
	...
	/**
	 * Returns a string representation of this delta's immediate structure suitable for debug
	 * purposes.
	 */
	...
	/**
	 * Provides a new set of markers for the delta. This is used when the delta is reused in cases
	 * where the only changes are marker changes.
	 */
	...
	/**
	 * Writes a string representation of this delta's immediate structure on the given string
	 * buffer.
	 */
