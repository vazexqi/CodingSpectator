...
/**
 * This class is the internal basis for all builders. Plugin developers should not subclass this
 * class.
 * 
...
public abstract class InternalBuilder {
	/**
	 * Hold a direct reference to the build manager as an optimization. This will be initialized by
	 * BuildManager when it is constructed.
	 */
	...
	/**
	 * Returns the ID of the nature that owns this builder. Returns null if the builder does not
	 * belong to a nature.
	 */
	...
	/**
	 * Returns true if the builder requested that its last built state be forgotten, and false
	 * otherwise.
	 */
