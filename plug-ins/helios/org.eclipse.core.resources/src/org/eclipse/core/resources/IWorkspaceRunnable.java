...
/**
 * A runnable which executes as a batch operation within the workspace. The
 * <code>IWorkspaceRunnable</code> interface should be implemented by any class whose instances are
 * intended to be run by <code>IWorkspace.run</code>.
 * <p>
