 ...
 * <p>
 * Filter descriptors are platform-defined objects that exist independent of whether that filter's
...
public interface IFilterMatcherDescriptor {
	...
	/**
	 * An argument filter type constant (value "filters"), denoting that this filter takes an array
	 * of other filters as argument.
	 */
