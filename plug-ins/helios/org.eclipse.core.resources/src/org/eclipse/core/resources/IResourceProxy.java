 ...
 * <p>
 * When a resource proxy is used within an {@link IResourceProxyVisitor}, it is a transient object
 * that is only valid for the duration of a single visit method. A proxy should not be referenced
 * once the single resource visit is complete. The equals and hashCode methods should not be relied
 * on.
 * </p>
 * <p>
...
public interface IResourceProxy {
	 ...
	 * 
	 * @return the modification stamp, or <code>NULL_STAMP</code> if the resource either does not
	 ...
	 * 
	 * @return <code>true</code> if the resource is accessible, and <code>false</code> otherwise
	 ...
	 * 
	 * @return <code>true</code> if the resource is marked as derived, and <code>false</code>
	 *         otherwise
	 ...
	 * 
	 * @return <code>true</code> if the resource is linked, and <code>false</code> otherwise
	 ...
	 * 
	 * @return <code>true</code> if the resource is a phantom resource, and <code>false</code>
	 *         otherwise
	 ...
	 * 
	 * @return <code>true</code> if the resource is a hidden resource, and <code>false</code>
	 *         otherwise
	 ...
	 * 
	 * @return <code>true</code> if the resource is a team private member, and <code>false</code>
	 *         otherwise
	 ...
	 * given key. Returns <code>null</code> if this resource has no such property.
	 * <p>
	 * Note that this method can return an out of date property value, or a value that no longer
	 * exists, if session properties are being modified concurrently with the resource visit.
	 * </p>
	 * 
	 * @param key the qualified name of the property
	 * @return the string value of the session property, or <code>null</code> if the resource has no
	 *         such property
	 ...
	 * <p>
	 * Note that this is not a &quot;free&quot; proxy operation. This method will generally cause a
	 ...
	 * both a path object and a resource object to be created. For an optimal visitor, only call
	 * this method when absolutely necessary. Note that the simple resource name can be obtained
	 * from the proxy with no cost, and the full path of the resource can be obtained through the
	 * proxy with smaller cost.
	 * </p>
	 * 
