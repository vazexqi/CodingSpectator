...
public class IncrementalBuild extends Task {
	...
	/**
	 * Unique identifier constant (value <code>"incremental"</code>) indicating that an incremental
	 * build should be performed.
	 */
	public final static String KIND_INCREMENTAL= "incremental"; //$NON-NLS-1$

	/**
	 * Unique identifier constant (value <code>"full"</code>) indicating that a full build should be
	 * performed.
	 */
	public final static String KIND_FULL= "full"; //$NON-NLS-1$

	/**
	 * Unique identifier constant (value <code>"auto"</code>) indicating that an auto build should
	 * be performed.
	 */
	public final static String KIND_AUTO= "auto"; //$NON-NLS-1$

	/**
	 * Unique identifier constant (value <code>"clean"</code>) indicating that a CLEAN build should
	 * be performed.
	 */
	 ...
	 * <code>IncrementalBuild.KIND_FULL</code>, <code>IncrementalBuild.KIND_AUTO</code>,
	 * <code>IncrementalBuild.KIND_INCREMENTAL</code>, <code>IncrementalBuild.KIND_CLEAN</code>.
	 * 
