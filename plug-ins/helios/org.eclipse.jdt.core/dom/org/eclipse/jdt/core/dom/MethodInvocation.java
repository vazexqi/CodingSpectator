...
public class MethodInvocation extends Expression {
	...
	/**
	 * Creates a new AST node for a method invocation expression owned by the given AST. By default,
	 * no expression, no type arguments, an unspecified, but legal, method name, and an empty list
	 * of arguments.
	 * 
	...
	/**
	 * Returns the expression of this method invocation expression, or <code>null</code> if there is
	 * none.
	 * 
	...
	/**
	 * Returns <code>true</code> if the resolved return type has been inferred from the assignment
	 * context (JLS3 15.12.2.8), <code>false</code> otherwise.
	 * <p>
	 * This information is available only when bindings are requested when the AST is being built
	 * </p>
	 * .
	 * 
	 * @return <code>true</code> if the resolved return type has been inferred from the assignment
	 *         context (JLS3 15.12.2.8), <code>false</code> otherwise
	 * @since 3.3
	 */
