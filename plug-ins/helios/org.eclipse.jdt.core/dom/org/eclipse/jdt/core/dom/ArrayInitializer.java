...
public class ArrayInitializer extends Expression {
	...
	/**
	 * The list of expressions (element type: <code>Expression</code>). Defaults to an empty list.
	 */
	private ASTNode.NodeList expressions=
			new ASTNode.NodeList(EXPRESSIONS_PROPERTY);

	/**
	 * Creates a new AST node for an array initializer owned by the given AST. By default, the list
	 ...
	 * 
	 * @return the live list of expressions (element type: <code>Expression</code>)
	 */
