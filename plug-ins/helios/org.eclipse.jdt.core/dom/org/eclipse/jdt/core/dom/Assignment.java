...
public class Assignment extends Expression {
	...
	public static class Operator {
		...
		/**
		 * Returns the assignment operator corresponding to the given string, or <code>null</code>
		 * if none.
		 * <p>
	...
	/**
	 * Creates a new AST node for an assignment expression owned by the given AST. By default, the
	 * node has an assignment operator, and unspecified left and right hand sides.
	 * 
