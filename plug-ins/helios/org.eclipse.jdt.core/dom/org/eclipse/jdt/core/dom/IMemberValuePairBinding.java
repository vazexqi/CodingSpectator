...
/**
 * Represents a resolved instance of an annotation's member value pair. Resolved annotation are
 * computed along with other bindings; these objects correspond to {@link MemberValuePair} nodes.
 * 
 * @since 3.2
...
public interface IMemberValuePairBinding extends IBinding {
	...
	/**
	 * @return <code>true</code> iff this member value pair's value is the default value. Returns
