 ...
 * <p>
 * This kind of node is used to convert a type declaration node into a statement node by wrapping
 * it.
 * </p>
 * For JLS2:
 * 
 ...
 * </pre>
 * 
 * Although allowed at the AST, not all arrangements of AST nodes are meaningful; in particular,
 * only class and enum declarations are meaningful in the context of a block.
 * 
 * @since 2.0
...
public class TypeDeclarationStatement extends Statement {
	...
	/**
	 * The type declaration; lazily initialized; defaults to a unspecified, but legal, type
	 * declaration. In JLS2, corresponds to TYPE_DECLARATION_PROPERTY. After JLS2, corresponds to
	...
	/**
	 * The child property stored on the <code>typeDecl</code> instance variable. In JLS2,
	 * corresponds to TYPE_DECLARATION_PROPERTY. After JLS2, corresponds to DECLARATION_PROPERTY.
	 * 
	 * @return the property corresponding to the <code>typeDecl</code> instance variable; never
	 *         <code>null</code>
	 */
	...
	/**
	 * Creates a new unparented local type declaration statement node owned by the given AST. By
	 * default, the local type declaration is an unspecified, but legal, type declaration.
	 * <p>
	...
	/**
	 * Returns the abstract type declaration of this local type declaration statement (added in JLS3
	 * API).
	 * 
	...
	/**
	 * Sets the abstract type declaration of this local type declaration statement (added in JLS3
	 * API).
	 * 
	 ...
	 * @deprecated In the JLS3 API, this method is replaced by {@link #getDeclaration()}, which
	 *             returns <code>AbstractTypeDeclaration</code> instead of
