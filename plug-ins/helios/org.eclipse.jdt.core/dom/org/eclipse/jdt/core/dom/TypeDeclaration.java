...
/**
 * Type declaration AST node type. A type declaration is the union of a class declaration and an
 * interface declaration. For JLS2:
 * 
 * <pre>
 * TypeDeclaration:
 * 		ClassDeclaration
 ...
 * </pre>
 * 
 * For JLS3, type parameters and reified modifiers (and annotations) were added, and the superclass
 * type name and superinterface types names are generalized to type so that parameterized types can
 * be referenced:
 * 
 * <pre>
 * TypeDeclaration:
 ...
 * character of the first modifier or annotation (if any), or the first character of the "class" or
 * "interface" keyword (if no modifiers or annotations). The source range extends through the last
...
public class TypeDeclaration extends AbstractTypeDeclaration {
	...
	/**
	 * The optional superclass name; <code>null</code> if none. Defaults to none. Note that this
	 * field is not used for interface declarations. Not used in 3.0.
	 */
	private Name optionalSuperclassName= null;

	/**
	 * The superinterface names (element type: <code>Name</code>). JLS2 only; defaults to an empty
	 * list. Not used in JLS3. (see constructor).
	 * 
	 */
	private ASTNode.NodeList superInterfaceNames= null;

	/**
	 * The optional superclass type; <code>null</code> if none. Defaults to none. Note that this
	 * field is not used for interface declarations. Null in JLS2. Added in JLS3.
	 * 
	 * @since 3.1
	 */
	...
	/**
	 * The superinterface types (element type: <code>Type</code>). Null in JLS2. Added in JLS3;
	 * defaults to an empty list (see constructor).
	 * 
	 * @since 3.1
	 */
	...
	/**
	 * Creates a new AST node for a type declaration owned by the given AST. By default, the type
	 * declaration is for a class of an unspecified, but legal, name; no modifiers; no javadoc; no
	 * type parameters; no superclass or superinterfaces; and an empty list of body declarations.
	 * <p>
	 ...
	 * 
	 * @return <code>true</code> if this is an interface declaration, and <code>false</code> if this
	 ...
	 * 
	 * @param isInterface <code>true</code> if this is an interface declaration, and
	...
	/**
	 * Returns the live ordered list of type parameters of this type declaration (added in JLS3
	 * API). This list is non-empty for parameterized types.
	 * 
	...
	/**
	 * Returns the name of the superclass declared in this type declaration, or <code>null</code> if
	 * there is none (JLS2 API only).
	 * <p>
	 * Note that this child is not relevant for interface declarations (although it does still
	 * figure in subtree equality comparisons).
	 * </p>
	 * 
	 ...
	 * @deprecated In the JLS3 API, this method is replaced by {@link #getSuperclassType()}, which
	 *             returns a <code>Type</code> instead of a <code>Name</code>.
	 */
	...
	/**
	 * Returns the superclass declared in this type declaration, or <code>null</code> if there is
	 * none (added in JLS3 API).
	 * <p>
	 * Note that this child is not relevant for interface declarations (although it does still
	 * figure in subtree equality comparisons).
	 * </p>
	 ...
	 * </p>
	 * 
	 * @param superclassName the superclass name node, or <code>null</code> if there is none
	 ...
	 *                </ul>
	 * @exception UnsupportedOperationException if this operation is used in an AST later than JLS2
	 * @deprecated In the JLS3 API, this method is replaced by {@link #setSuperclassType(Type)},
	 ...
	 * </p>
	 * 
	 * @param superclassType the superclass type node, or <code>null</code> if there is none
	 * @exception IllegalArgumentException if:
	 *                <ul>
	 *                <li>the node belongs to a different AST</li>
	 *                <li>the node already has a parent</li>
	...
	/**
	 * Returns the live ordered list of names of superinterfaces of this type declaration (JLS2 API
	 * only). For a class declaration, these are the names of the interfaces that this class
	 * implements; for an interface declaration, these are the names of the interfaces that this
	 * interface extends.
	 * 
	 * @return the live list of interface names (element type: <code>Name</code>)
	 * @exception UnsupportedOperationException if this operation is used in an AST later than JLS2
	...
	/**
	 * Returns the live ordered list of superinterfaces of this type declaration (added in JLS3
	 * API). For a class declaration, these are the interfaces that this class implements; for an
	 * interface declaration, these are the interfaces that this interface extends.
	 * 
	 * @return the live list of interface types (element type: <code>Type</code>)
	 * @exception UnsupportedOperationException if this operation is used in a JLS2 AST
	 * @since 3.1
	 */
	...
	/**
	 * Returns the ordered list of field declarations of this type declaration. For a class
	 * declaration, these are the field declarations; for an interface declaration, these are the
	 * constant declarations.
	 * <p>
	 * This convenience method returns this node's body declarations with non-fields filtered out.
	 * Unlike <code>bodyDeclarations</code>, this method does not return a live result.
	 * </p>
	 * 
	 ...
	 * <p>
	 * This convenience method returns this node's body declarations with non-methods filtered out.
	 * Unlike <code>bodyDeclarations</code>, this method does not return a live result.
	 * </p>
	 * 
	 ...
	 * <p>
	 * This convenience method returns this node's body declarations with non-types filtered out.
	 * Unlike <code>bodyDeclarations</code>, this method does not return a live result.
	 * </p>
	 * 
