...
public abstract class VariableDeclaration extends ASTNode {
	 ...
	 * <p>
	 * For example, <code>int x[][]</code> has a type of <code>int</code> and two extra array
	 * dimensions; <code>int[][] x</code> has a type of <code>int[][]</code> and zero extra array
	 * dimensions. The two constructs have different ASTs, even though there are really syntactic
	 * variants of the same variable declaration.
	 * </p>
	 * 
	 ...
	 * 
	 * @param initializer the initializer expression node, or <code>null</code> if there is none
	 * @exception IllegalArgumentException if:
	 *                <ul>
	 *                <li>the node belongs to a different AST</li>
	 *                <li>the node already has a parent</li>
