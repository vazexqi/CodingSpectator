...
/**
 * Descriptor for a simple property of an AST node. A simple property is one whose value is a
 * primitive type (such as <code>int</code> or <code>boolean</code>) or some simple value type (such
 * as <code>String</code> or <code>InfixExpression.Operator</code>).
 * 
...
public final class SimplePropertyDescriptor extends StructuralPropertyDescriptor {
	...
	/**
	 * Value type. For example, for a node type like SingleVariableDeclaration, the modifiers
	 * property is int.class
	 */
	...
	/**
	 * Creates a new simple property descriptor with the given property id. Note that this
