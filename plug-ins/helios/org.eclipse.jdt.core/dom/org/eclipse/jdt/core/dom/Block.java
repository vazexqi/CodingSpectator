...
public class Block extends Statement {
	...
	/**
	 * The list of statements (element type: <code>Statement</code>). Defaults to an empty list.
	 */
	...
	/**
	 * Returns the live list of statements in this block. Adding and removing nodes from this list
	 * affects this node dynamically. All nodes in this list must be <code>Statement</code>s;
	 * attempts to add any other type of node will trigger an exception.
	 * 
	 * @return the live list of statements in this block (element type: <code>Statement</code>)
	 */
