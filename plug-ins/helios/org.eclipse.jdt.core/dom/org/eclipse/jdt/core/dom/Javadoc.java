...
public class Javadoc extends Comment {
	...
	/**
	 * The doc comment string, including opening and closing comment delimiters; defaults to a
	 * minimal Javadoc comment.
	 * 
	 * @deprecated The comment string was replaced in the 3.0 release by a representation of the
	 *             structure of the doc comment. For backwards compatibility, it is still
	 *             funcational as before.
	 */
	private String comment= MINIMAL_DOC_COMMENT;

	/**
	 * The list of tag elements (element type: <code>TagElement</code>). Defaults to an empty list.
	 * 
	 * @since 3.0
	 */
	...
	/**
	 * Creates a new AST node for a doc comment owned by the given AST. The new node has an empty
	 * list of tag elements (and, for backwards compatability, an unspecified, but legal, doc
	 * comment string).
	 * <p>
	 ...
	 * @deprecated The comment string was replaced in the 3.0 release by a representation of the
	 *             structure of the doc comment. See {@link #tags() tags}.
	 */
	...
	/**
	 * Sets or clears the doc comment string. The documentation string must include the starting and
	 * ending comment delimiters, and any embedded line breaks.
	 * 
	 ...
	 * <p>
	 * The tag elements cover everything except the starting and ending comment delimiters, and
	 * generally omit leading whitespace (including a leading "*") and embedded line breaks. The
	 * first tag element of a typical doc comment represents all the material before the first
	 * explicit doc tag; this first tag element has a <code>null</code> tag name and generally
	 * contains 1 or more {@link TextElement}s, and possibly interspersed with tag elements for
	 * nested tags like "{@link String String}". Subsequent tag elements represent successive
	 * top-level doc tag (e.g., "@param", "@return", "@see").
	 * </p>
	 * <p>
	 * Adding and removing nodes from this list affects this node dynamically.
	 * </p>
	 * 
	 * @return the live list of tag elements in this doc comment (element type:
