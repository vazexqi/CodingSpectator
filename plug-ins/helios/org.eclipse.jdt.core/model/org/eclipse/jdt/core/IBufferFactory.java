...
public interface IBufferFactory {
	...
	/**
	 * Creates a buffer for the given owner. The new buffer will be initialized with the contents of
	 * the owner if and only if it was not already initialized by the factory (a buffer is
