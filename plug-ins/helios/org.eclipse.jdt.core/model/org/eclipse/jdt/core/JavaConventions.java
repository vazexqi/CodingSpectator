...
public final class JavaConventions {
	...
	private static final Scanner SCANNER= new Scanner(false /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_3 /*sourceLevel*/, null/*taskTag*/, null/*taskPriorities*/,
	 ...
	 *         name
	 * @deprecated Use
	 *             {@link #validateCompilationUnitName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * @since 2.0
	 * @deprecated Use
	 *             {@link #validateClassFileName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * <p>
	 * Syntax of a field name corresponds to VariableDeclaratorId (JLS2 8.3). For example,
	 * <code>"x"</code>.
	 * 
	 * @param name the name of a field
	 * @return a status object with code <code>IStatus.OK</code> if the given name is valid as a
	 *         field name, otherwise a status object indicating what is wrong with the name
	 * @deprecated Use
	 *             {@link #validateFieldName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * keyword, boolean literal (<code>"true"</code>, <code>"false"</code>), or null literal (
	 ...
	 *         identifier
	 * @deprecated Use
	 *             {@link #validateIdentifier(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * must not have the same spelling as a Java keyword, boolean literal (<code>"true"</code>,
	 * <code>"false"</code>), or null literal (<code>"null"</code>). See section 3.8 of the
	 * <em>Java Language Specification, Second Edition</em> (JLS2). A valid identifier can act as a
	 * simple type name, method name or field name.
	 * 
	 * @param id the Java identifier
	 ...
	 * <p>
	 * The name of an import corresponds to a fully qualified type name or an on-demand package name
	 * as defined by ImportDeclaration (JLS2 7.5). For example, <code>"java.util.*"</code> or
	 ...
	 * @deprecated Use
	 *             {@link #validateImportDeclaration(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 *         the name
	 * @deprecated Use
	 *             {@link #validateJavaTypeName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * {@link JavaCore} class. The constants are named <code>JavaCore#VERSION_1_x</code>, x being
	 * set between '1' and '7'.
	 * </p>
	 * 
	 * @param name the name of a type
	 ...
	 * valid.
	 * <p>
	 * The syntax for a method name is defined by Identifier of MethodDeclarator (JLS2 8.4). For
	 * example "println".
	 * 
	 ...
	 * @deprecated Use
	 *             {@link #validateMethodName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * <p>
	 * Note that the given name must be a non-empty package name (that is, attempting to validate
	 ...
	 * @deprecated Use
	 *             {@link #validatePackageName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * with the project itself, or if the output location is excluded from the source folder.
	 * </ul>
	 * </ul>
	 * 
	 ...
	 * @return a status object with code <code>IStatus.OK</code> if the given name is valid as a
	 *         type variable name, otherwise a status object indicating what is wrong with the name
	 * @since 3.1
	 * @deprecated Use
	 *             {@link #validateTypeVariableName(String id, String sourceLevel, String complianceLevel)}
	 *             instead
	 */
	 ...
	 * {@link JavaCore#getDefaultOptions()} method.
	 * 
	 * @param javaProject the given java project
	 ...
	 *         valid, otherwise a status object indicating what is wrong with the keys and their
	 *         value.
