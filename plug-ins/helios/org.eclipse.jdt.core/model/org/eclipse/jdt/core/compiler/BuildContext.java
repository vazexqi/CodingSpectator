 ...
 * {@link CompilationParticipant#buildStarting(BuildContext[], boolean) a build is starting}, or to
 * annotations processors when {@link CompilationParticipant#processAnnotations(BuildContext[]) a
 * source file has annotations}.
 * 
 * @since 3.2
...
public class BuildContext {
	 ...
	 * 
	 * NOTE: This is only valid during
	...
	/**
	 * Record the fully-qualified type names of any new dependencies, each name is of the form
	 * "p1.p2.A.B".
	 * 
	...
	/**
	 * Record new problems to report against this compilationUnit. Markers are persisted for these
	 * problems only for the declared managed marker type (see the 'compilationParticipant'
	 * extension point).
	 * 
