...
public interface IAttributeNamesConstants {
	 ...
	 * "Synthetic" attribute.
	 * <p>
	 * Note that prior to JDK 1.5, synthetic elements were always marked using an attribute; with
	 * 1.5, synthetic elements can also be marked using the {@link IModifierConstants#ACC_SYNTHETIC}
	 * flag.
	 * </p>
	 * 
	 * @since 2.0
	...
	/**
	 * "Signature" attribute (added in J2SE 1.5). Class file readers which support J2SE 1.5 return
	 * attributes with this name represented by objects implementing {@link ISignatureAttribute}.
	 * 
	 * @since 3.0
	 */
	...
	/**
	 * "EnclosingMethod" attribute (added in J2SE 1.5). Class file readers which support J2SE 1.5
	 * return attributes with this name represented by objects implementing
	 * {@link IEnclosingMethodAttribute}.
	 * 
	 * @since 3.0
	 */
