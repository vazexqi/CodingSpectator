...
public interface IGlobalVariable {
	/**
	 * Returns the initializer of this global variable. The syntax for an initializer corresponds to
	 * VariableInitializer (JLS2 8.3).
	 * 
	 * @return the initializer expression, or <code>null</code> if this global does not have an
	 *         initializer
	 */
	...
	/**
	 * Returns the fully qualified name of the type of this global variable, or its simple
	 * representation if it is a primitive type (<code>int</code>, <code>boolean</code>, etc.).
	 * <p>
