...
public interface ICorrectionRequestor {
	 ...
	 * @param returnTypeName Name of the return type of this method, should be <code>null</code> for
	 *            a constructor.
	 * @param correctionName The correction for the method. Can include zero, one or two brackets.
	 ...
	 * @param correctionName The correction for the package. Can include '.*;' for imports.
