...
class PackageFragmentRootInfo extends OpenableElementInfo {
	...
	/**
	 * The SourceMapper for this JAR (or <code>null</code> if this JAR does not have source
	 * attached).
	 */
	 ...
	 * <li><code>IPackageFragmentRoot.K_BINARY</code>
	 * </ul>
	 */
	...
	/**
	 * Starting at this folder, create non-java resources for this package fragment root and add
	 * them to the non-java resources collection.
	 * 
	...
	/**
	 * Retuns the SourceMapper for this root, or <code>null</code> if this root does not have
	 * attached source.
	 */
