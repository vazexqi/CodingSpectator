...
/**
 * Implements <code>IJavaElementRequestor</code>, wrappering and forwarding results onto a
...
class SearchableEnvironmentRequestor extends JavaElementRequestor {
	/**
	 * The <code>ISearchRequestor</code> this JavaElementRequestor wraps and forwards results to.
	 */
	protected ISearchRequestor requestor;

	/**
	 * The <code>ICompilationUNit</code> this JavaElementRequestor will not accept types within.
	 */
	...
	/**
	 * Constructs a SearchableEnvironmentRequestor that wraps the given SearchRequestor. The
	 * requestor will not accept types in the <code>unitToSkip</code>.
	 */
	...
	/**
	 * Do nothing, a SearchRequestor does not accept initializers so there is no need to forward
	 * this results.
	 * 
