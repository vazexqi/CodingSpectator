...
/**
 * This operation creates a new package fragment under a given package fragment root. The following
 * must be specified:
 * <ul>
 ...
 * </ul>
 * <p>
 * Any needed folders/package fragments are created. If the package fragment already exists, this
 * operation has no effect. The result elements include the <code>IPackageFragment</code> created
 * and any side effect package fragments that were created.
 * 
 * <p>
...
public class CreatePackageFragmentOperation extends JavaModelOperation {
	...
	/**
	 * When executed, this operation will create a package fragment with the given name under the
	 * given package fragment root. The dot-separated name is broken into segments. Intermediate
	 * folders are created as required for each segment. If the folders already exist, this
	...
	/**
	 * Execute the operation - creates the new package fragment and any side effect package
	 * fragments.
	 * 
	 ...
	 * in the package fragment's hierarchy.
	...
	public IJavaModelStatus verify() {
		...
		if (this.pkgName == null
				|| (this.pkgName.length > 0 && JavaConventions.validatePackageName(packageName, project.getOption(JavaCore.COMPILER_SOURCE, true),
