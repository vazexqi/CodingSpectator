 ...
 * <ul>
 * <li>Containing Type
 * <li>The source code for the initializer. No verification of the source is performed.
 * </ul>
 */
public class CreateInitializerOperation extends CreateTypeMemberOperation {
	/**
	 * The current number of initializers in the parent type. Used to retrieve the handle of the
	 * newly created initializer.
	 */
	protected int numberOfInitializers= 1;

	/**
	 * When executed, this operation will create an initializer with the given name in the given
	 * type with the specified source.
	 * 
	 * <p>
	 * By default the new initializer is positioned after the last existing initializer declaration,
