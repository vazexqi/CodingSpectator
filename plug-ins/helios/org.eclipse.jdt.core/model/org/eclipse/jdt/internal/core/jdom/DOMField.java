...
class DOMField extends DOMMember implements IDOMField {
	...
	/**
	 * Contains the type of the field when the type has been altered from the contents in the
	...
	/**
	 * The contents of the initializer when the initializer has been altered from the original state
	 ...
	 *            document.
	 * @param name - the identifier portion of the name of this field, corresponding to
	 *            VariableDeclaratorId (JLS 8.3).
	 ...
	 * @param typeRange - a two element array describing the location of the typeName in the
	 *            document - the positions of the first and last characters of the typeName.
	 * @param type - the type of the field, in normalized form, as defined in Type in Field
	 *            Declaration (JLS 8.3)
	 * @param hasInitializer - true if this field declaration includes an initializer, otherwise
	 *            false
	 * @param initRange - a two element array describing the location of the initializer in the
	 *            declaration. The first integer is the position of the character following the
	 *            equals sign, and the position of the last character is the last in the
	 *            initializer. If this field has no initializer, this array contains two -1's.
	 * @param isVariableDeclarator - true if the field is a seconday variable declarator for a
	 *            previous field declaration.
	 */
	DOMField(char[] document, int[] sourceRange, String name, int[] nameRange, int[] commentRange, int flags, int[] modifierRange, int[] typeRange, String type, boolean hasInitializer,
	...
	/**
	 * Expands all variable declarators in this field declaration into stand-alone field
	 * declarations.
	 */
	...
	/**
	 * Returns a String representing this field declaration as a field declaration with one variable
	 * declarator.
	 */
	...
	/**
	 * Returns true is this field declarations has more than one variable declarator, otherwise
	 * false;
	 */
	 ...
	 * Once inserted, the sibling is only dependent on this document fragment.
	 * 
	 * <p>
	...
	/**
	 * Returns true if this field is declared as a secondary variable declarator for a previous
	 * field declaration.
	 */
	...
	/**
	 * Sets the state of this field declaration as being a secondary variable declarator for a
	 * previous field declaration.
	 */
	...
	/**
	 * Sets the state of this field declaration as having the field type altered from the original
	 * document.
	 */
