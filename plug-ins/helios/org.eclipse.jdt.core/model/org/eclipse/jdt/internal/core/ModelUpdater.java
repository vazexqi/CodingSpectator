...
/**
 * This class is used by <code>JavaModelManager</code> to update the JavaModel based on some
...
public class ModelUpdater {
	 ...
	 * <code>IJavaElementDelta</code>s. Return whether the delta corresponds to a resource on the
