...
public class JavaElementRequestor implements IJavaElementRequestor {
	...
	/**
	 * A collection of the resulting fields, or <code>null</code> if no field results have been
	 * received.
	 */
	protected ArrayList fields= null;

	/**
	 * A collection of the resulting initializers, or <code>null</code> if no initializer results
	 * have been received.
	 */
	protected ArrayList initializers= null;

	/**
	 * A collection of the resulting member types, or <code>null</code> if no member type results
	 * have been received.
	 */
	protected ArrayList memberTypes= null;

	/**
	 * A collection of the resulting methods, or <code>null</code> if no method results have been
	 * received.
	 */
	protected ArrayList methods= null;

	/**
	 * A collection of the resulting package fragments, or <code>null</code> if no package fragment
	 * results have been received.
	 */
	protected ArrayList packageFragments= null;

	/**
	 * A collection of the resulting types, or <code>null</code> if no type results have been
	 * received.
	 */
