...
/**
 * A java element delta builder creates a java element delta on a java element between the version
 * of the java element at the time the comparator was created and the current version of the java
 * element.
 * 
 * It performs this operation by locally caching the contents of the java element when it is
...
public class JavaElementDeltaBuilder {
	...
	/**
	 * Builds the java element deltas between the old content of the compilation unit and its new
	 * content.
	 */
