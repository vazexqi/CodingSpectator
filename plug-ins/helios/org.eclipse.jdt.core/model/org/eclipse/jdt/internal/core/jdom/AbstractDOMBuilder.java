...
public class AbstractDOMBuilder extends ReferenceInfoAdapter implements ILineStartFinder {
	...
	/**
	 * True when a compilation unit is being constructed. False when any other type of document
	 * fragment is being constructed.
	 */
	protected boolean fBuildingCU= false;

	/**
	 * True when a compilation unit or type is being constructed. False when any other type of
	 * document fragment is being constructed.
	 */
	...
	/**
	 * A stack of enclosing scopes used when constructing a compilation unit or type. The top of the
	 * stack is the document fragment that children are added to.
	 */
	protected Stack fStack= null;

	/**
	 * The number of fields constructed in the current document. This is used when building a single
	 * field document fragment, since the DOMBuilder only accepts documents with one field
	 * declaration.
	 */
	...
	/**
	 * @see org.eclipse.jdt.internal.compiler.IDocumentElementRequestor#enterClass(int, int[], int,
	 *      int, int, char[], int, int, char[], int, int, char[][], int[], int[], int)
	 */
	...
	/**
	 * Finishes the configuration of the compilation unit DOM object which was created by a previous
	 * enterCompilationUnit call.
	 * 
