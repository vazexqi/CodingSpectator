...
/**
 * The <code>CharArrayBuffer</code> is intended as a lightweight partial implementation of the
 * StringBuffer class, but using <code>char[]'s</code> instead of Strings.
 * 
 * <p>
 * The <code>CharArrayBuffer</code> maintains a list of <code>char[]'s</code> which don't get
 * appended until the user asks for them. The following code illustrates how to use the class.
 * 
 * <code>
...
public class CharArrayBuffer {
	/**
	 * This is the buffer of char arrays which must be appended together during the getContents
	 * method.
	 */
	...
	/**
	 * A buffer of ranges which is maintained along with the buffer. Ranges are of the form {start,
	 * length}. Enables append(char[] array, int start, int end).
	 */
	...
	/**
	 * Creates a <code>CharArrayBuffer</code> with the default buffer size, and sets the first
	 * element in the buffer to be the given char[].
	 * 
	...
	/**
	 * Creates a <code>CharArrayBuffer</code> with the given buffer size, and sets the first element
	 * in the buffer to be the given char array.
	 * 
	...
	/**
	 * Appends the given String to the buffer. Given for convenience, use #append(char[]) if
	 * possible
	 * 
	 * @param src - a char array which is appended to the end of the buffer.
	 */
	...
	/**
	 * Returns the entire contents of the buffer as one char[] or null if nothing has been put in
	 * the buffer.
	 */
