...
/**
 * The selection engine is intended to infer the nature of a selected name in some source code. This
 * name can be qualified.
 * 
 * Selection is resolving context using a name environment (no need to search), assuming the source
 * where selection occurred is correct and will not perform any completion attempt. If this was the
 * desired behavior, a call to the CompletionEngine should be performed instead.
 */
public final class SelectionEngine extends Engine implements ISearchRequestor {
	 ...
	 * 
	 * @param nameEnvironment org.eclipse.jdt.internal.core.SearchableEnvironment used to resolve
	...
	/**
	 * Ask the engine to compute the selection at the specified position of the given compilation
	 * unit.
	 * 
	 ...
	 * @param selectionSourceEnd int a range in the source where the selection is.
	 */
	public void select(
				...
				if (constructorDeclaration.selector == assistIdentifier) {
					if (constructorDeclaration.binding != null) {
						...
						if (constructorDeclaration.scope != null) {
							throw new SelectionNodeFound(new MethodBinding(constructorDeclaration.modifiers, constructorDeclaration.selector, null, null, null,
	 ...
	 * 
	 * @param typeName char[] a type name which is to be resolved in the context of a compilation
	 *            unit. NOTE: the type name is supposed to be correctly reduced (no whitespaces, no
	 *            unicodes left)
	 * 
	 * @param context org.eclipse.jdt.core.IType the context in which code assist is invoked.
	 */
