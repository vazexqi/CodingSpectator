...
public class ClassFileReader extends ClassFileStruct implements IBinaryType {
	...
	/**
	 * @param classFileBytes byte[] Actual bytes of a .class file
	 * 
	 * @param fileName char[] Actual name of the file that contains the bytes, can be null
	 * 
	 * @param fullyInitialize boolean Flag to fully initialize the new object
	 * @exception ClassFormatException
	 */
	...
	/**
	 * Answer the receiver's access flags. The value of the access_flags item is a mask of modifiers
	 * used with class and interface declarations.
	 * 
	 * @return int
	 */
 ...
 */
	...
	/**
	 * Answer the source name if the receiver is a inner type. Return null if it is an anonymous
	 * class or if the receiver is a top-level class. e.g. public class A { public class B { }
	 * public void foo() { class C {} } public Runnable bar() { return new Runnable() { public void
	 * run() {} }; } } It returns {'B'} for the member A$B It returns null for A It returns {'C'}
	 * for the local class A$1$C It returns null for the anonymous A$1
	 * 
	 * @return char[]
	 */
...
*/
	 ...
	 * the AccDeprecated and AccSynthetic bits if necessary
	 * 
	 * @return int
	 */
	...
	/**
	 * Answer the major/minor version defined in this class file according to the VM spec. as a
	 * long: (major<<16)+minor
	 * 
	 ...
	 * Structural changes are: - modifiers changes for the class, the this.fields or the
	 * this.methods - signature changes for this.fields or this.methods. - changes in the number of
	 * this.fields or this.methods - changes for field constants - changes for thrown exceptions -
	 * change for the super class or any super interfaces. - changes for member types name or
	 * modifiers If any of these changes occurs, the method returns true. false otherwise. The
	 * synthetic fields are included and the members are not required to be sorted.
	 * 
	 * @param newBytes the bytes of the .class file we want to compare the receiver to
	 * @return boolean Returns true is there is a structural change between the two .class files,
	 *         false otherwise
	 */
	 ...
	 * this.fields or this.methods - changes for field constants - changes for thrown exceptions -
	 * change for the super class or any super interfaces. - changes for member types name or
	 * modifiers If any of these changes occurs, the method returns true. false otherwise.
	 * 
	 * @param newBytes the bytes of the .class file we want to compare the receiver to
	 * @param orderRequired a boolean indicating whether the members should be sorted or not
	 * @param excludesSynthetic a boolean indicating whether the synthetic members should be used in
	 *            the comparison
	 * @return boolean Returns true is there is a structural change between the two .class files,
	 *         false otherwise
	 */
	...
	/**
	 * Answer the source file name attribute. Return null if there is no source file attribute for
	 * the receiver.
	 * 
	 * @return char[]
	 */
