...
public interface ITypeRequestor {
	...
	/**
	 * Accept the unresolved source forms for the requested type. Note that the multiple source
	 * forms can be answered, in case the target compilation unit contains multiple types. The first
	 * one is then guaranteed to be the one corresponding to the requested type.
	 */
