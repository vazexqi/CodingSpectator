...
public interface IBinaryType extends IGenericType {
	...
	/**
	 * Answer the enclosing method (including method selector and method descriptor), or null if
	 * none.
	 * 
	...
	/**
	 * Answer the receiver's signature which describes the parameter & return types as specified in
	 * section 4.4.4 of the Java 2 VM spec 3rd edition. Returns null if none.
	 * 
...
// so the local types do not have to be included.
	...
	/**
	 * Answer the list of missing type names which were referenced from the problem classfile. This
	 * list is encoded via an extra attribute.
	 */
	...
	/**
	 * Answer the simple name of the type in the class file. For member A$B, will answer B. For
	 * anonymous will answer null.
	 */
	char[] getSourceName();
