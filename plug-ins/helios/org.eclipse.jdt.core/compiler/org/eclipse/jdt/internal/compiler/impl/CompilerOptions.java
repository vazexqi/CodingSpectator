...
public class CompilerOptions {
	...
	/**
	 * Bit mask for configurable problems (error/warning threshold) Note: bitmask assumes 3 highest
	 * bits to denote irritant group (to allow storing 8 groups of 29 bits each
	 */
	// group 0
	...
	/**
	 * Classfile debug information, may contain source file name, line numbers, local variable
	 * tables, etc...
	 */
	public int produceDebugAttributes;

	/**
	 * Compliance level for the compiler, refers to a JDK version, e.g. {link
	 * {@link ClassFileConstants#JDK1_4}
	 */
	...
	/**
	 * Specify if need to report missing override annotation for a method implementing an interface
	 * method (java 1.6 and above)
	 */
	...
	/**
	 * Return the most specific option key controlling this irritant. Note that in some case, some
	 * irritant is controlled by other master options (e.g. javadoc, deprecation, etc.). This
	 * information is intended for grouping purpose (several problems governed by a rule)
	 */
	 ...
	 * 
	 * @return all warning option names TODO (maxime) revise for ensuring completeness
	 */
