 ...
 * method. Only top-level and member types are reported. Local types are not reported.
 * <p>
 * While {@link TypeNameRequestor} only reports type names information (e.g. package, enclosing
 * types, simple name, modifiers, etc.), this class reports {@link TypeNameMatch} objects instead,
 * which store this information and can return an {@link org.eclipse.jdt.core.IType} handle.
 * </p>
 * <p>
