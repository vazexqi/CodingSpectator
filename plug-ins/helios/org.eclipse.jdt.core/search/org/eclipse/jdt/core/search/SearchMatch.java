 ...
 * 
 * Search matches may be accurate (<code>A_ACCURATE</code>) or they might be merely potential
 * matches (<code>A_INACCURATE</code>). The latter occurs when a compile-time problem prevents the
 * search engine from completely resolving the match.
 * <p>
 * This class is intended to be instantiated and subclassed by clients.
 * </p>
 * 
 * @see SearchEngine#search(SearchPattern, SearchParticipant[], IJavaSearchScope, SearchRequestor,
...
public class SearchMatch {
	...
	/**
	 * The search result is potentially a match for the search pattern, but the search engine is
	 * unable to fully check it (for example, because there are errors in the code or the classpath
	 ...
	 * </p>
	 * 
	 * @param element the element that encloses or corresponds to the match, or <code>null</code> if
	 *            none
	...
	/**
	 * Returns the element of this search match. In case of a reference match, this is the
	 * inner-most enclosing element of the reference. In case of a declaration match, this is the
	 * declaration.
	 * 
	...
	/**
	 * Returns whether match element is compatible with searched pattern or not. Note that
	 * equivalent matches are also erasure ones.
	 * 
	 * @return <code>true</code> if match element is compatible <code>false</code> otherwise
	 * @since 3.1
	 */
	...
	/**
	 * Returns whether match element only has same erasure than searched pattern or not. Note that
	 * this is always true for both generic and non-generic element as soon as the accuracy is
	 * accurate.
	 * 
	 * @return <code>true</code> if match element has same erasure <code>false</code> otherwise
	 * @since 3.1
	 */
	...
	/**
	 * Returns whether element matches exactly searched pattern or not. Note that exact matches are
	 * also erasure and equivalent ones.
	 * 
	 ...
	 * 
	 * Note that this piece of information is currently only implemented for implicit member pair
	 * value in annotation.
	 * 
	 * @return <code>true</code> if this match is associated to an implicit element and
	 ...
	 * 
	 * @return <code>true</code> if this match is associated to a raw type or method and
	 *         <code>false</code> otherwise
	 * @since 3.1
	 */
	 ...
	 * 
	 * @param insideDoc <code>true</code> if this search match is inside a doc comment, and
	 *            <code>false</code> otherwise
	 */
	...
	/**
	 * Sets whether the associated element is implicit or not. Typically, this is the case when
	 * match is on an implicit constructor or an implicit member pair value in annotation.
	 * 
	 * @param implicit <code>true</code> if this match is associated to an implicit element and
	 *            <code>false</code> otherwise
	 * @since 3.1
	 */
	 ...
	 *            {@link SearchPattern#R_EQUIVALENT_MATCH} or {@link SearchPattern#R_ERASURE_MATCH}
	 * @since 3.1
	 */
	 ...
	 * 
	 * @param raw <code>true</code> if this search match is associated to a raw type or method and
	 *            <code>false</code> otherwise
	 * @since 3.1
	 */
