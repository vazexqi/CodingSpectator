...
/**
 * A match collected while {@link SearchEngine searching} for all type names methods using a
 * {@link TypeNameRequestor requestor}.
 * <p>
...
public abstract class TypeNameMatch {
	 ...
	 * @see IAccessRule
	 * 
	 * @return the accessibility of the type name which may be {@link IAccessRule#K_ACCESSIBLE},
	 *         {@link IAccessRule#K_DISCOURAGED} or {@link IAccessRule#K_NON_ACCESSIBLE}. The
	 *         default returned value is {@link IAccessRule#K_ACCESSIBLE}.
	 * 
	 * @since 3.6
	 */
	 ...
	 * package name + '.' enclosing type names + '.' simple name).
	 * 
	 * @see #getType()
	 ...
	 * <p>
	 * This is a handle-only method as neither Java Model nor classpath initialization is done while
	 * calling this method.
	 * 
	...
	/**
	 * Returns the package fragment root of the stored type. Package fragment root cannot be null
	 * and <strong>does</strong> exist.
	 * 
	 * @see #getType()
	 * @see IJavaElement#getAncestor(int)
	 * 
	 * @throws NullPointerException if matched type is <code> null</code>
	 * @return the existing java model package fragment root (ie. cannot be <code>null</code> and
	 *         will return <code>true</code> to <code>exists()</code> message).
	 */
	...
	/**
	 * Returns a java model type handle. This handle may exist or not, but is not supposed to be
	 * <code>null</code>.
	 * <p>
	 * This is a handle-only method as neither Java Model nor classpath initializations are done
	...
	/**
	 * Name of the type container using '.' character as separator (e.g. package name + '.' +
	 * enclosing type names).
	 * 
	 * @see #getType()
	 ...
	 * enclosing type names + '.' + simple name).
	 * 
	 * @see #getType()
