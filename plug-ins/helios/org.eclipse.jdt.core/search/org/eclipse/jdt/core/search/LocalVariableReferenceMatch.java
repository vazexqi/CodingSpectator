...
/**
 * A Java search match that represents a local variable reference. The element is the inner-most
 * enclosing member that references this local variable.
 * <p>
...
public class LocalVariableReferenceMatch extends SearchMatch {
	 ...
	 */
	public LocalVariableReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean isReadAccess, boolean isWriteAccess, boolean insideDocComment,
	...
	/**
	 * Returns whether the local variable reference is a read access to the variable. Note that a
	 * local variable reference can be read and written at once in case of compound assignments
	 * (e.g. i += 0;)
	 * 
	...
	/**
	 * Returns whether the local variable reference is a write access to the variable. Note that a
	 * local variable reference can be read and written at once in case of compound assignments
	 * (e.g. i += 0;)
	 * 
