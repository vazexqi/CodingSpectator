...
/**
 * A Java search match that represents a field reference. The element is the inner-most enclosing
 * member that references this field.
 * <p>
...
public class FieldReferenceMatch extends ReferenceMatch {
	 ...
	 */
	public FieldReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean isReadAccess, boolean isWriteAccess, boolean insideDocComment,
	...
	/**
	 * Returns whether the field reference is a read access to the field. Note that a field
	 * reference can be read and written at once in case of compound assignments (e.g. i += 0;)
	 * 
	...
	/**
	 * Returns whether the field reference is a write access to the field. Note that a field
	 * reference can be read and written at once in case of compound assignments (e.g. i += 0;)
	 * 
