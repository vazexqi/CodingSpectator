...
public abstract class AbstractJavaSearchScope extends AbstractSearchScope {
	 ...
	 *         unit access rule set when scope does not enclose the given path.
	 */
	 ...
	 * @return the {@link IPackageFragmentRoot package fragment root} which path match the given one
