 ...
 * <p>
 * It might have one or several blocks ( see {@link FormatJavadocBlock}). The javadoc comment might
 * starts with a <b>description</b> which means that its first block has no tag.
 * </p>
 */
public class FormatJavadoc extends Javadoc {
	 ...
	 * 
	 * @return <code>true</code> if the javadoc comment has several lines <code>false</code>
	 *         otherwise (e.g. header and footer are on the same line).
	 */
