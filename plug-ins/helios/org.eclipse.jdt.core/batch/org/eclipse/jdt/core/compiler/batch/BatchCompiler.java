...
public final class BatchCompiler {
	...
	/**
	 * Invokes the Eclipse Compiler for Java with the given command line arguments, using the given
	 * writers to print messages, and reporting progress to the given compilation progress. Returns
	 ...
	 * </ul>
	 * <p>
	 * The specification of the command line arguments is defined by running the batch compiler's
	 * help
	 * 
	 * <pre>
	 ...
	 * @param progress the object to report progress to and to provide cancellation, or
	 *            <code>null</code> if no progress is needed
	 ...
	 * 
	 * </p>
	 * Note that a <code>true</code> returned value indicates that no errors were reported, no
	 * runtime exceptions occurred and that the compilation was not canceled.
	 * 
