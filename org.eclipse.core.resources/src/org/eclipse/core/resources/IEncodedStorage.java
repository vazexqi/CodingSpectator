 ...
 * 
 * <p>
 * The <code>IEncodedStorage</code> interface extends <code>IStorage</code> in order to provide
...
public interface IEncodedStorage extends IStorage {
	 ...
	 * @exception CoreException if an error happens while determining the charset. See any
