...
public interface ISynchronizer {
	 ...
	 *            <code>IResource.DEPTH_ZERO</code>, <code>IResource.DEPTH_ONE</code>, or
	 ...
	 *                <li><code>IResourceStatus.PARTNER_NOT_REGISTERED</code> The sync partner is
	 *                not registered.</li>
	 *                </ul>
	 */
	...
	/**
	 * Discards the named partner's synchronization information associated with the specified
	 * resource and its descendents to the specified depth.
	 * 
	 * @param partner the sync partner name
	...
	/**
	 * Sets the named sync partner's synchronization information for the given resource. If the
	 * given info is non-<code>null</code> and the resource neither exists nor is a phantom, this
	 * method creates a phantom resource to hang on to the info. If the given info is
	 * <code>null</code>, any sync info for the resource stored by the given sync partner is
	 * discarded; in some cases, this may result in the deletion of a phantom resource if there is
	 * no more sync info to maintain for that resource.
	 * <p>
	 * Sync information is not stored on the workspace root. Attempts to set information on the root
	 * will be ignored.
	 * </p>
	 * 
	 * @param partner the sync partner name
