 ...
 * context for searching for preference values (in the
 * <code>org.eclipse.core.runtime.IPreferencesService</code> APIs) or for determining the correct
 * preference node to set values in the store.
 * <p>
 * Project preferences are stored on a per project basis in the project's content area as specified
 * by <code>IProject#getLocation</code>.
 * </p>
 * <p>
 * The path for preferences defined in the project scope hierarchy is as follows:
 * <code>/project/&lt;projectName&gt;/&lt;qualifier&gt;</code>
 * </p>
 * <p>
