 ...
 * <p>
 * Nature descriptors are platform-defined objects that exist independent of whether that nature's
 * plug-in has been started. In contrast, a project nature's runtime object (
 * <code>IProjectNature</code>) generally runs plug-in-defined code.
 * </p>
 * 
 * @see IProjectNature
...
public interface IProjectNatureDescriptor {
	 ...
	 * <p>
	 * The nature identifier is composed of the nature's plug-in id and the simple id of the nature
	 * extension. For example, if plug-in <code>"com.xyz"</code> defines a nature extension with id
	 * <code>"myNature"</code>, the unique nature identifier will be <code>"com.xyz.myNature"</code>
	 * .
	 * </p>
	 * 
	...
	/**
	 * Returns the unique identifiers of the natures required by this nature. Nature requirements
	 * are specified by the <code>"requires-nature"</code> element on a nature extension. Returns an
	 * empty array if no natures are required by this nature.
	 * 
	...
	/**
	 * Returns the identifiers of the nature sets that this nature belongs to. Nature set inclusion
	 * is specified by the <code>"one-of-nature"</code> element on a nature extension. Returns an
	 * empty array if no nature sets are specified for this nature.
	 * 
	 ...
	 * 
	 * @return boolean <code>true</code> if creating links is allowed, and <code>false</code>
	 *         otherwise.
