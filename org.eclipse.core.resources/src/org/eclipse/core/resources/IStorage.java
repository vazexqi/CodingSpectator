 ...
 * <code>IFile</code> or <code>IFileState</code> or any other object supplied by user code. The main
 * role of an <code>IStorage</code> is to provide a uniform API for access to, and presentation of,
 * its content.
 * <p>
 * Storage objects implement the <code>IAdaptable</code> interface; extensions are managed by the
...
public interface IStorage extends IAdaptable {
	 ...
	 * 
	 * @return the path related to the data represented by this storage or <code>null</code> if
	 *         none.
	 */
	public IPath getFullPath();

	/**
	 * Returns the name of this storage. The name of a storage is synonymous with the last segment
	 * of its full path though if the storage does not have a path, it may still have a name.
	 * 
	 * @return the name of the data represented by this storage, or <code>null</code> if this
	 *         storage has no name
	 * @see #getFullPath()
	 */
