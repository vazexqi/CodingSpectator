...
/**
 * An interface that variable providers should implement in order to extends the default path
 * variable list used to resolve relative locations of linked resources.
 * 
 * @since 3.6
 */
public abstract class PathVariableResolver {
	 ...
	 * <p>
	 * This default implementation always returns <code>null</code>. Subclasses should override to
	 * provide custom extensions.
	 * </p>
	 * 
	 * @param variable The current variable name.
	 * @param resource The resource that the variable is being resolved for.
