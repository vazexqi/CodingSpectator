...
public interface IMarkerDelta {
	 ...
	 * following classes: <code>String</code>, <code>Integer</code>, or <code>Boolean</code>.
	 * Returns <code>null</code> if the attribute is undefined. The set of valid attribute names is
	 * defined elsewhere.
	 * <p>
	 * If kind is <code>IResourceDelta.ADDED</code>, then the information is from the new marker,
	 ...
	 * the attribute is undefined or is not a string value.
	 * <p>
	 * If kind is <code>IResourceDelta.ADDED</code>, then the information is from the new marker,
	 * otherwise it is from the old marker.
	 * </p>
	 ...
	 * following classes: <code>String</code>, <code>Integer</code>, or <code>Boolean</code>. If the
	 * marker has no attributes then <code>null</code> is returned.
	 * <p>
	 * If kind is <code>IResourceDelta.ADDED</code>, then the information is from the new marker,
	 * otherwise it is from the old marker.
	 * </p>
	...
	/**
	 * Returns the attributes with the given names. The result is an array whose elements correspond
	 * to the elements of the given attribute name array. Each element is <code>null</code> or an
	 * instance of one of the following classes: <code>String</code>, <code>Integer</code>, or
	 * <code>Boolean</code>.
	 * <p>
	 * If kind is <code>IResourceDelta.ADDED</code>, then the information is from the new marker,
	 * otherwise it is from the old marker.
	...
	/**
	 * Returns the kind of this marker delta: one of <code>IResourceDelta.ADDED</code>,
	...
	/**
	 * Returns the marker described by this change. If kind is <code>IResourceDelta.REMOVED</code>,
