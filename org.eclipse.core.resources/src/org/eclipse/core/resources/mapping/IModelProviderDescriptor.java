 ...
 * <p>
 * Model provider descriptors are platform-defined objects that exist independent of whether that
 * model provider's plug-in has been started. In contrast, a model provider's runtime object (
 * <code>ModelProvider</code>) generally runs plug-in-defined code.
 * </p>
 * 
