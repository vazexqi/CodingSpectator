...
/**
 * The abstract base class for all file info matchers. Instances of this class are provided using
 * the <tt>org.eclipse.core.resources.filterMatchers</tt> extension point.
 * 
 * @since 3.6
 */
public abstract class AbstractFileInfoMatcher {
	 ...
	 * @return <code>true</code> if the given {@link FileInfo} matches, and <code>false</code>
	 *         otherwise.
	 * @throws CoreException the implementor should throw a CoreException if, in the case that the
	 *             parent or fileInfo doesn't exist in the workspace or in the file system, the
	 *             return value can't be determined.
	 */
