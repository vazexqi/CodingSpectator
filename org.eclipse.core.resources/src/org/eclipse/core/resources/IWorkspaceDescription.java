...
public interface IWorkspaceDescription {
	 ...
	 * setting is ignored by the workspace when <code>isApplyFileStatePolicy()</code> returns
	 * <code>false</code>.
	 * 
	 ...
	 * This setting is ignored by the workspace when <code>isApplyFileStatePolicy()</code> returns
	 * <code>false</code>.
	 * 
	 ...
	 * <code>setFileStateLongevity(long)</code>, <code>setMaxFileStates(int)</code> and
	 * <code>setMaxFileStateSize(long)</code> methods.
	 * 
	 ...
	 * <p>
	 * When autobuild is on, any changes made to a project and its resources automatically triggers
	 * an incremental build of the workspace.
	 * </p>
	 * <p>
	 * Users must call <code>IWorkspace.setDescription</code> before changes made to this
	 ...
	 * list are built in a default order defined by the workspace. Set this value to
	 * <code>null</code> to use the default ordering for all projects. Projects not named in the
	 * list are built in unspecified order after all ordered projects.
	 * <p>
	 * Users must call <code>IWorkspace.setDescription</code> before changes made to this
	 * description take effect.
	 * </p>
	 ...
	 * This setting is ignored by the workspace when <code>setApplyFileStatePolicy(boolean)
	 ...
	 * </p>
	 * 
	 * @param time the maximum number of milliseconds a file state should be kept in the local
	 *            history
	 * @see IWorkspace#setDescription(IWorkspaceDescription)
	...
	/**
	 * Sets the interval between automatic workspace snapshots. The new interval will only take
	 * effect after the next snapshot.
	 * <p>
	 * Users must call <code>IWorkspace.setDescription</code> before changes made to this
	 * description take effect.
	 * </p>
