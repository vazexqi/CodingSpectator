...
public class ResourceAttributes {
	...
	/**
	 * Creates a new resource attributes instance with attributes taken from the specified file in
	 * the file system. If the specified file does not exist or is not accessible, this method has
	 * the same effect as calling the default constructor.
	 * 
	 ...
	 * 
	 * @return <code>true</code> if this resource is marked as read only, <code>false</code>
	 *         otherwise
	 ...
	 * 
	 * @param readOnly <code>true</code> to set it to be marked read only, <code>false</code> to
	 *            unset
	 * @see #isReadOnly()
	 */
	 ...
	 * 
	 * @param symLink <code>true</code> to set it to be marked as symbolic link, <code>false</code>
	 *            to unset
	 * @see #isSymbolicLink()
	 * @since 3.4
	 */
