...
public interface ICommand {
	 ...
	 * 
	 * @return a table of command arguments (key type : <code>String</code> value type :
	 ...
	 * default, commands are only configurable if the corresponding builder defines the
	 * {@link #isConfigurable} attribute in its builder extension declaration. A command that is not
	 ...
	 * <code>null</code> if there are no arguments. The argument names and values are both strings.
	 * <p>
	 ...
	 * permanently you must install the command into the relevant project build spec using
	 * {@link IProjectDescription#setBuildSpec(ICommand[])}.
	 * </p>
	 * 
	 * @param args a table of command arguments (keys and values must both be of type
	 *            <code>String</code>), or <code>null</code>
	 * @see #getArguments()
	 */
	 ...
	 * <p>
	 * The builder name comes from the extension that plugs in to the standard
	 * <code>org.eclipse.core.resources.builders</code> extension point.
	 * </p>
	 * 
	 ...
	 * <p>
	 * When a command is configured to not respond to a given kind of build, the builder instance
