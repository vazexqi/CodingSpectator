...
public class ResourceRuleFactory implements IResourceRuleFactory {
	 ...
	 * <p>
	 * Subclasses may override this method. The rule provided by an overriding method must at least
	 ...
	 * implementation returns a rule that combines the parent of the source resource and the parent
	 ...
	 * @return the parent resource for folders and files, and the resource itself for projects and
	 *         the workspace root.
	 */
	 ...
	 * <code>null</code> if there are no read-only resources.
	 * <p>
	 * Subclasses may override this method. The rule provided by an overriding method must at least
	 * contain the rule from this default implementation.
	 * 
