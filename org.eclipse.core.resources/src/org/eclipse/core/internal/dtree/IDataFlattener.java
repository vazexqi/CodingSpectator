...
public interface IDataFlattener {
	 ...
	 * @return the object associated with the given path, which may be <code>null</code>.
	 */
	 ...
	 * @param data the object associated with the given path, which may be <code>null</code>.
	 */
