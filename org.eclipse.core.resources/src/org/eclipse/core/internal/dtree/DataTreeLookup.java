...
/**
 * The result of doing a lookup() in a data tree. Uses an instance pool that assumes no more than
 * POOL_SIZE instance will ever be needed concurrently. Reclaims and reuses instances on an LRU
 * basis.
 */
