...
/**
 * <code>DataTreeNode</code>s are the nodes of a <code>DataTree</code>. Their information and their
 * subtrees are complete, and do not represent deltas on another node or subtree.
 */
public class DataTreeNode extends AbstractDataTreeNode {
	 ...
	 * node and all children. Returns null if this node should no longer be included in the
	 * comparison tree.
	 */
	...
	/**
	 * Returns a new node containing a child with the given local name in addition to the receiver's
	 * current children and data.
	 * 
	 * @param localName name of new child
	 * @param childNode new child node
	 */
	...
	/**
	 * Returns a new node without the specified child, but with the rest of the receiver's current
	 * children and its data.
	 * 
	 * @param localName name of child to exclude
	 */
	...
	/**
	 * Returns an array of delta nodes representing the forward delta between the given two lists of
	 * nodes. The given nodes must all be complete nodes.
	 */
	...
	/**
	 * Returns a node representing the forward delta between the given two (complete) nodes, or null
	 * if the two nodes are equal. Although typed as abstract nodes, the given nodes must be
	 * complete.
	 */
