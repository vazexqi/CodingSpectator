...
/**
 * A <code>DataDeltaNode</code> contains information that represents the differences between itself
 * and a node in another tree. Refer to the <code>DeltaDataTree</code> API and comments for details.
 * 
 * @see DeltaDataTree
 */
public class DataDeltaNode extends DataTreeNode {
	...
	/**
	 * Creates and returns a new copy of the receiver. Makes a deep copy of children, but a shallow
	 * copy of name and data.
	 */
