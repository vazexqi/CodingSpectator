...
/**
 * A <code>DataTree</code> represents the complete information of a source tree. The tree contains
 * all information within its branches, and has no relation to any other source trees (no parent and
 * no children).
 */
public class DataTree extends AbstractDataTree {
	...
	/**
	 * Creates and returns an instance of the receiver. This is an implementation of the factory
	 ...
	 * 
	 * @param key Key of parent node whose subtree we want to create/replace.
	 * @param subtree New node to insert into tree.
	 */
	 ...
	 * 
	 * @param key Node whose data to return.
	 */
