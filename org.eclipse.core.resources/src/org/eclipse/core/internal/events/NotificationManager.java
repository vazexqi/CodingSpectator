...
public class NotificationManager implements IManager, ILifecycleListener {
	...
	/**
	 * Indicates whether a notification is currently in progress. Used to avoid causing a
	 * notification to be requested as a result of another notification.
	 */
	...
	/**
	 * Indicates the beginning of a block where periodic notifications should be avoided. Returns
	 * true if notification avoidance really started, and false for nested operations.
	 */
	...
	/**
	 * Computes and returns the resource delta for the given event type and the given current tree
	 * state.
	 */
	...
	/**
	 * Returns true if a notification is needed. This happens if sufficient time has elapsed since
