...
public class LifecycleEvent {
	...
	/**
	 * For events that only involve one resource, this is it. More specifically, this is used for
	 * all events that don't involve a more or copy. For copy/move events, this resource represents
	 * the source of the copy/move.
	 */
