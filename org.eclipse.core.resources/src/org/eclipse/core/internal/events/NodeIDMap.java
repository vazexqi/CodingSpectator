...
/**
 * A specialized map that maps Node IDs to their old and new paths. Used for calculating moves
 * during resource change notification.
 */
public class NodeIDMap {
	...
	/**
	 * Returns the index of the given element in the map. If not found, returns -1.
	 */
	...
	/**
	 * Adds the given path mappings to the map. If either oldPath or newPath is null, they are
	 * ignored (old map values are not overwritten).
	 */
