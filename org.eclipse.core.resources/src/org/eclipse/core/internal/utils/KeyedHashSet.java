...
public class KeyedHashSet {
	...
	/**
	 * Adds an element to this set. If an element with the same key already exists, replaces it
	 * depending on the replace flag.
	 * 
	...
	/**
	 * The element at the given index has been removed so move elements to keep the set properly
	 * hashed.
	 */
