 ...
 * Typically a single <code>StringPool</code> instance will be created, and a group of participants
 * will be asked to store their strings in the pool. This allows participants to share equal strings
