...
/**
 * A cache that keeps a collection of at most maximumCapacity+threshold entries. When the number of
 * entries exceeds that limit, least recently used entries are removed so the current size is the
 * same as the maximum capacity.
 */
public class Cache {
