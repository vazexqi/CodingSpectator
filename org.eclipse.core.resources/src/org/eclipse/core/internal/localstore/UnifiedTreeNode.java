...
/**
 * A node in a {@link UnifiedTree}. A node usually represents a file/folder in the workspace, the
 * file system, or both. There are also special node instances to act as child and level markers in
 * the tree.
 */
public class UnifiedTreeNode implements ILocalStoreConstants {
	...
	/**
	 * Releases elements that won't be needed any more for garbage collection. Should be called
	 * before adding a node to the free list.
	 */
