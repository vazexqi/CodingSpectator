...
/**
 * Visits a unified tree, and throws a ResourceChangedException on the first node that is discovered
 * to be out of sync. The exception that is thrown will not have any meaningful status, message, or
 * stack trace. Nodes discovered to be out of sync are not brought to be in sync with the workspace.
 */
