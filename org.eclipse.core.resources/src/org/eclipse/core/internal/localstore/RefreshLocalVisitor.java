...
public class RefreshLocalVisitor implements IUnifiedTreeVisitor, ILocalStoreConstants {
	...
	/**
	 * This method has the same implementation as resourceChanged but as they are different cases,
	 * we prefer to use different methods.
	 */
	...
	/**
	 * Returns the status of the nodes visited so far. This will be a multi-status that describes
	 * all problems that have occurred, or an OK status if everything went smoothly.
	 */
	 ...
	 * - RL_NOT_IN_SYNC - the resource is not in-sync with file system - RL_UNKNOWN - couldn't
	 * determine the sync status for this resource
	 */
