...
/**
 * A bucket is a persistent dictionary having paths as keys. Values are determined by subclasses.
 * 
 * @since 3.1
 */
public abstract class Bucket {
	...
	public static abstract class Entry {
		...
		/**
		 * Logical path of the object we are storing history for. This does not correspond to a file
		 * system path.
		 */
		private IPath path;
	...
	/**
	 * Map of the history entries in this bucket. Maps (String -> byte[][]), where the key is the
	 * path of the object we are storing history for, and the value is the history entry data
	 * (UUID,timestamp) pairs.
	 */
	...
	/**
	 * The project name for the bucket currently loaded. <code>null</code> if this is the root
	 * bucket.
	 */
	...
	/**
	 * Flushes this bucket so it has no contents and is not associated to any location. Any
	...
	/**
	 * Defines how data for a given entry is to be read from a bucket file. To be implemented by
	 * subclasses.
	 */
