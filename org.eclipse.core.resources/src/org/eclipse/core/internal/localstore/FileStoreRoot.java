...
/**
 * Represents the root of a file system that is connected to the workspace. A file system can be
 * rooted on any resource.
 */
public class FileStoreRoot {
	private int chop;

	/**
	 * When a root is changed, the old root object is marked invalid so that other resources with a
	 * cache of the root will know they need to update.
	 */
	private boolean isValid= true;

	/**
	 * If this root represents a resource in the local file system, this path represents the root
	 * location. This value is null if the root represents a non-local file system
	 */
	 ...
	 * 
	 * @param rootURI The virtual file representing the root of the file system that has been
	 *            mounted
	 * @param workspacePath The workspace path at which this file system has been mounted
	 */
	...
	/**
	 * Returns the resolved, absolute file system location of the resource corresponding to the
	 * given workspace path, or null if none could be computed.
	 */
