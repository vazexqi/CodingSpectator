...
/**
 * Given a target and a temporary locations, it tries to read the contents from the target. If a
 * file does not exist at the target location, it tries to read the contents from the temporary
 * location.
 * 
