...
/**
 * This class should be used when there's a file already in the destination and we don't want to
 * lose its contents if a failure writing this stream happens. Basically, the new contents are
 * written to a temporary location. If everything goes OK, it is moved to the right place. The user
 * has the option to define the temporary location or it will be created in the default-temporary
 * directory (see java.io.File for details).
 */
