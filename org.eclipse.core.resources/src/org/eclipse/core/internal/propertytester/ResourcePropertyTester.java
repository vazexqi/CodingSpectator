...
public class ResourcePropertyTester extends PropertyTester {
	...
	/**
	 * A property indicating the file extension (value <code>"extension"</code>). "*" and "?" wild
	 * cards are supported.
	 */
	protected static final String EXTENSION= "extension"; //$NON-NLS-1$

	/**
	 * A property indicating the file name (value <code>"name"</code>). "*" and "?" wild cards are
	 * supported.
	 */
	protected static final String NAME= "name"; //$NON-NLS-1$

	/**
	 * A property indicating the file path (value <code>"path"</code>). "*" and "?" wild cards are
	 * supported.
	 */
	 ...
	 * <code>"persistentProperty"</code>). If two arguments are given, this treats the first as the
	 * property name, and the second as the expected property value. If only one argument (or just
	 * the expected value) is given, this treats it as the property name, and simply tests for
	 ...
	 * <code>"projectPersistentProperty"</code>). If two arguments are given, this treats the first
	 * as the property name, and the second as the expected property value. If only one argument (or
	 * just the expected value) is given, this treats it as the property name, and simply tests for
	 * existence of the property on the resource.
	 */
	 ...
	 * <code>"projectSessionProperty"</code>). If two arguments are given, this treats the first as
	 * the property name, and the second as the expected property value. If only one argument (or
	 * just the expected value) is given, this treats it as the property name, and simply tests for
	 * existence of the property on the resource.
	 */
	 ...
	 * <code>"sessionProperty"</code>). If two arguments are given, this treats the first as the
	 * property name, and the second as the expected property value. If only one argument (or just
	 * the expected value) is given, this treats it as the property name, and simply tests for
	 * existence of the property on the resource.
	 */
	 ...
	 *            session property
	 * @param args additional arguments to evaluate the property. If of length 0, this treats the
	 *            expectedValue as the property name and does a simple check for existence of the
	 *            property. If of length 1, this treats the first argument as the property name and
	 *            does a simple check for existence of the property. If of length 2, this treats the
	 *            first argument as the property name, the second argument as the expected value,
	 *            and checks for equality with the actual property value.
	 * @param expectedValue used only if args is of length 0 (see Javadoc for args parameter)
	 ...
	 * @return <code>false</code> if the expected value equals Boolean.FALSE, <code>true</code>
	 *         otherwise
	 */
	 ...
	 * 
	 * @param expectedValue the expected value (may be <code>null</code>).
	 * @return the empty string if the expected value is <code>null</code>, otherwise the
	 *         <code>toString()</code> representation of the expected value
	 */
