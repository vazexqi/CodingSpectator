...
public class File extends Resource implements IFile {
	 ...
	 * All related properties are deleted. It is assumed that on disk the resource is already a
	...
	/**
	 * Optimized refreshLocal for files. This implementation does not block the workspace for the
	 * common case where the file exists both locally and on the file system, and is in sync. For
	 * all other cases, it defers to the super implementation.
	 */
	 ...
	 * 
	 * This method is called whenever it is discovered that a file has been modified (added,
	 * removed, or changed).
	 */
