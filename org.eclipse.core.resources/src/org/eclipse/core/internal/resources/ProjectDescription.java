...
public class ProjectDescription extends ModelObject implements IProjectDescription {
	...
	/**
	 * Map of (IPath -> LinkDescription) pairs for each linked resource in this project, where IPath
	 * is the project relative path of the resource.
	 */
	protected HashMap linkDescriptions= null;

	/**
	 * Map of (IPath -> LinkedList<FilterDescription>) pairs for each filtered resource in this
	 * project, where IPath is the project relative path of the resource.
	 */
	protected HashMap filterDescriptions= null;

	/**
	 * Map of (String -> VariableDescription) pairs for each variable in this project, where String
	...
	/**
	 * Returns the union of the description's static and dynamic project references, with duplicates
	 * omitted. The calculation is optimized by caching the result
	 */
	 ...
	 * Since this method is only used internally, it never creates a copy. Returns null if the
	 * project does not have any linked resources.
	 */
	 ...
	 * LinkedList<FilterDescription>). Since this method is only used internally, it never creates a
	 * copy. Returns null if the project does not have any filtered resources.
	 */
	...
	/**
	 * Returns the map of variable descriptions (String (variable name) -> VariableDescription).
	 * Since this method is only used internally, it never creates a copy. Returns null if the
	 * project does not have any variables.
	 */
	...
	/**
	 * Returns the URI to load a resource snapshot from. May return <code>null</code> if no snapshot
	 * is set.
	 * <p>
	 * <strong>EXPERIMENTAL</strong>. This constant has been added as part of a work in progress.
	 * There is no guarantee that this API will work or that it will remain the same. Please do not
	 * use this API without consulting with the Platform Core team.
	 * </p>
	 * 
	 * @return the snapshot location URI, or <code>null</code>.
	...
	/**
	 * Returns true if any private attributes of the description have changed. Private attributes
	 * are those that are not stored in the project description file (.project).
	 */
	...
	/**
	 * Returns true if any public attributes of the description have changed. Public attributes are
	 * those that are stored in the project description file (.project).
	 */
	...
	/**
	 * Sets the map of link descriptions (String name -> LinkDescription). Since this method is only
	 * used internally, it never creates a copy. May pass null if this project does not have any
	 * linked resources
	 */
	...
	/**
	 * Sets the map of filter descriptions (String name -> LinkedList<LinkDescription>). Since this
	 * method is only used internally, it never creates a copy. May pass null if this project does
	 * not have any filtered resources
	 */
	...
	/**
	 * Sets the map of variable descriptions (String name -> VariableDescription). Since this method
	 * is only used internally, it never creates a copy. May pass null if this project does not have
	 * any variables
	 */
	...
	/**
	 * Sets the description of a link. Setting to a description of null will remove the link from
	 * the project description.
	 * 
	 * @return <code>true</code> if the description was actually changed, <code>false</code>
	 *         otherwise.
	...
	/**
	 * Add the description of a filter. Setting to a description of null will remove the filter from
	 * the project description.
	 */
	...
	/**
	 * Sets the description of a variable. Setting to a description of null will remove the variable
	...
	/**
	 * set the filters for a given resource. Setting to a description of null will remove the filter
	 * from the project description.
	 * 
	 * @return <code>true</code> if the description was actually changed, <code>false</code>
	 *         otherwise.
	...
	/**
	 * Sets the location URI for a project snapshot that may be loaded automatically when the
	 * project is created in a workspace.
	 * <p>
	 ...
	 * </p>
	 * 
	 * @param snapshotLocation the location URI or <code>null</code> to clear the setting
	 * @see IProject#loadSnapshot(int, URI, IProgressMonitor)
