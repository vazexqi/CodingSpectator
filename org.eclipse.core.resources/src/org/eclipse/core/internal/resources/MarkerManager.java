...
public class MarkerManager implements IManager {
	...
	/**
	 * Adds the new markers to the given set of markers. If added, the markers are associated with
	 * the specified resource.IMarkerDeltas for Added markers are generated.
	 */
	...
	/**
	 * Removes markers of the specified type from the given resource. Note: this method is protected
	 * to avoid creation of a synthetic accessor (it is called from an anonymous inner class).
	 */
	...
	/**
	 * Returns all markers of the specified type on the given target, with option to search the
	 * target's children. Passing <code>null</code> for the type specifies a match for all types
	 * (i.e., <code>null</code> is a wildcard.
	 */
	...
	/**
	 * Fills the provided list with all markers of the specified type on the given target, with
	 * option to search the target's children. Passing <code>null</code> for the type specifies a
	 * match for all types (i.e., <code>null</code> is a wildcard.
	 */
	...
	/**
	 * Finds the max severity across all problem markers on the given target, with option to search
	...
	/**
	 * Returns true if this manager has a marker delta record for the given marker id, and false
	 * otherwise.
	 */
	 ...
	 * <code>null</code> for the type specifies a match for all types (i.e., <code>null</code> is a
	 * wildcard.
	 */
