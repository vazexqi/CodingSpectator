...
public class MarkerReader_2 extends MarkerReader {
	 ...
	 * ATTRIBUTE* MARKER_ID -> long TYPE -> INDEX | QNAME INDEX -> byte int QNAME -> byte String
	 * ATTRIBUTES_SIZE -> short ATTRIBUTE -> ATTRIBUTE_KEY ATTRIBUTE_VALUE ATTRIBUTE_KEY -> String
	 * ATTRIBUTE_VALUE -> INTEGER_VALUE | BOOLEAN_VALUE | STRING_VALUE | NULL_VALUE INTEGER_VALUE ->
	 * byte int BOOLEAN_VALUE -> byte boolean STRING_VALUE -> byte String NULL_VALUE -> byte
	 */
