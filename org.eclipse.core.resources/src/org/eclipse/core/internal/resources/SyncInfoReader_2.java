...
/**
 * This class is used to read sync info from disk. This is the implementation for reading files with
 * version number 2.
 */
public class SyncInfoReader_2 extends SyncInfoReader {
	 ...
	 * RESOURCE_PATH -> String SIZE -> int SYNCINFO -> TYPE BYTES TYPE -> INDEX | QNAME INDEX -> int
	 * int QNAME -> int String BYTES -> byte[]
	 * 
	 */
