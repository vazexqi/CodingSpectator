...
public class ProjectDescriptionReader extends DefaultHandler implements IModelObjectConstants {
	...
	/**
	 * End a build triggers element and set the triggers for the current build command element.
	 */
	...
	/**
	 * End this group of group resources and add them to the project description.
	 */
	...
	/**
	 * For backwards compatibility, link locations in the local file system are represented in the
	 * project description under the "location" tag.
	 * 
	 * @param elementName
	 */
	...
	/**
	 * Link locations that are not stored in the local file system are represented in the project
	 * description under the "locationURI" tag.
	 * 
	 * @param elementName
	 */
