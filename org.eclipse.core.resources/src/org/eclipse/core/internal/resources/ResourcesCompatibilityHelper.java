...
public class ResourcesCompatibilityHelper {
	...
	/**
	 * Creates a history store. Decides which implementation of history store should be chosen, and
	 * whether conversion from the existing state should be performed by looking at some system
	 * properties.
	 */
	...
	public static IHistoryStore createHistoryStore(IPath location, int limit, boolean newImpl, boolean convert, boolean rename) throws ClassNotFoundException, NoSuchMethodException,
	...
	/**
	 * Creates a property manager. Decides which implementation of property manager should be
	 * chosen, and whether conversion from the existing state should be performed by looking at some
	 * system properties.
	 */
