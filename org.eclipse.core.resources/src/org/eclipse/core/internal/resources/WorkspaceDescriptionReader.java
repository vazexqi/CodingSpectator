...
/**
 * This class contains legacy code only. It is being used to read workspace descriptions which are
 * obsolete.
 */
public class WorkspaceDescriptionReader implements IModelObjectConstants {
	...
	/**
	 * A value was discovered in the workspace description file that was not a number. Log the
	 * exception.
	 */
