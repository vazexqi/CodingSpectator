...
public class RootInfo extends ResourceInfo {
	...
	/**
	 * Override parent's behaviour and do nothing. Sync information cannot be stored on the
	 * workspace root so we don't need to update this counter which is used for deltas.
	 */
