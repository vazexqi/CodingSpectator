 ...
 * 
 * This version differs from version 1 in the amount of information that is persisted for each
 * builder. Version 1 only stored builder names and trees. Version 2 stores builder names, project
 * names, trees, and interesting projects for each builder.
 */
