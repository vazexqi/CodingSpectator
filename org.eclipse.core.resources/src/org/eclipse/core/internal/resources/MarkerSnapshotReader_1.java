...
public class MarkerSnapshotReader_1 extends MarkerSnapshotReader {
	 ...
	 * MARKER -> MARKER_ID TYPE ATTRIBUTES_SIZE ATTRIBUTE* MARKER_ID -> long TYPE -> INDEX | QNAME
	 * INDEX -> byte int QNAME -> byte String ATTRIBUTES_SIZE -> short ATTRIBUTE -> ATTRIBUTE_KEY
	 * ATTRIBUTE_VALUE ATTRIBUTE_KEY -> String ATTRIBUTE_VALUE -> BOOLEAN_VALUE | INTEGER_VALUE |
	 * STRING_VALUE | NULL_VALUE BOOLEAN_VALUE -> byte boolean INTEGER_VALUE -> byte int
	 * STRING_VALUE -> byte String NULL_VALUE -> byte
	 */
