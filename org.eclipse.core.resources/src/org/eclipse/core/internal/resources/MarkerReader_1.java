...
public class MarkerReader_1 extends MarkerReader {
	...
	/**
	 * SAVE_FILE -> VERSION_ID RESOURCE+ VERSION_ID -> RESOURCE -> RESOURCE_PATH MARKERS_SIZE
	 * MARKER* RESOURCE_PATH -> String MARKERS_SIZE -> int MARKER -> MARKER_ID TYPE ATTRIBUTES_SIZE
	 * ATTRIBUTE* MARKER_ID -> long TYPE -> INDEX | QNAME INDEX -> int int QNAME -> int String
	 * ATTRIBUTES_SIZE -> int ATTRIBUTE -> ATTRIBUTE_KEY ATTRIBUTE_VALUE ATTRIBUTE_KEY -> String
	 * ATTRIBUTE_VALUE -> INTEGER_VALUE | BOOLEAN_VALUE | STRING_VALUE | NULL_VALUE INTEGER_VALUE ->
	 * int int BOOLEAN_VALUE -> int boolean STRING_VALUE -> int String NULL_VALUE -> int
	 */
