...
public class Convert {
	...
	/**
	 * Converts the given String to bytes using the platforms default encoding.
	 * 
	 * @param target The String to be converted, can not be <code>null</code>.
	 * @return byte[] The resulting bytes, or <code>null</code>.
	 */
	/**
	 * Calling String.getBytes() creates a new encoding object and other garbage. This can be
	 * avoided by calling String.getBytes(String encoding) instead.
	 */
