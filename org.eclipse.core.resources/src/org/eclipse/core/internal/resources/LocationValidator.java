...
public class LocationValidator {
	 ...
	 * <code>lastSegmentOnly</code> is true, it is assumed that all segments except the last one
	 * have previously been validated. This is an optimization for validating a leaf resource when
	 * it is known that the parent exists (and thus its parent path must already be valid).
	 */
