...
public class ProjectNatureDescriptor implements IProjectNatureDescriptor {
	...
	/**
	 * Returns the IDs of the incremental builders that this nature claims to own. These builders do
	 * not necessarily exist in the registry.
	 */
	...
	/**
	 * Returns the IDs of the content types this nature declares to have affinity with. These
	 * content types do not necessarily exist in the registry.
	 */
