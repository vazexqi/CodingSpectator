...
public class ProjectInfo extends ResourceInfo {
	...
	/**
	 * Discards stale natures on this project after project description has changed.
	 */
	...
	/**
	 * Discards any stale state on this project after it has been moved. Builder instances must be
	 * cleared because they reference the old project handle.
	 */
