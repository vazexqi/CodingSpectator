...
/**
 * Manages auto-refresh functionality, including maintaining the active set of monitors and
 * controlling the job that performs periodic refreshes on out of sync resources.
 * 
 * @since 3.0
 */
