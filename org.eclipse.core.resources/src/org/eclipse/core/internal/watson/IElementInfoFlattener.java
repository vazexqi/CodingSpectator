...
/**
 * The <code>IElementInfoFlattener</code> interface supports reading and writing element info
 * objects.
 */
public interface IElementInfoFlattener {
	 ...
	 * @return the object associated with the given elementPath, which may be <code>null</code>.
	 */
	 ...
	 * @param element the object associated with the given path, which may be <code>null</code>.
	 */
