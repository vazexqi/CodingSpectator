...
public interface IPropertyManager extends IManager {
	...
	/**
	 * Copy all the properties of one resource to another. Both resources must have a property store
	 * available.
	 */
	...
	/**
	 * Returns the value of the identified property on the given resource as maintained by this
	 * store.
	 * <p>
	...
	/**
	 * Returns a map (<propertyKey: QualifiedName -> value: String>) containing all properties
	 * defined for the given resource. In case no properties can be found, returns an empty map.
	 */
