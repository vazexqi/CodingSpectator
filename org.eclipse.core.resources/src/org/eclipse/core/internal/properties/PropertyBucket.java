...
public class PropertyBucket extends Bucket {
	public static class PropertyEntry extends Entry {
		...
		/**
		 * Deletes the property with the given name, and returns the result array. Returns the
		 * original array if the property to be deleted could not be found. Returns
		 * <code>null</code> if the property was found and the original array had size 1 (instead of
		 * a zero-length array).
		 */
