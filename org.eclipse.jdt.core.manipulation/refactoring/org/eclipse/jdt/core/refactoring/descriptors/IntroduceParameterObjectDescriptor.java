...
public class IntroduceParameterObjectDescriptor extends JavaRefactoringDescriptor {
	...
	public static class Parameter {
		...
		/**
		 * The name of the field that will be created if {@link #isCreateField()} is
		 * <code>true</code>
		 * 
		 ...
		 * special index {@link IntroduceParameterObjectDescriptor#PARAMETER_OBJECT_IDX}. The
		 * position in the new method signature depends on the position in the array passed to
		 * {@link IntroduceParameterObjectDescriptor#setParameters(IntroduceParameterObjectDescriptor.Parameter[])}
		 * 
		 * @return returns the index of the parameter in the original method signature or
		 *         {@link IntroduceParameterObjectDescriptor#PARAMETER_OBJECT_IDX} for the parameter
		 *         object
		 * 
		...
		/**
		 * If <code>true</code> the parameter will be removed from the method's signature and will
		 * be added to the parameter object. The default is <code>false</code>
		 * 
		 * @return <code>true</code> if the parameter will be created as field, <code>false</code>
		...
		/**
		 * Sets whether the parameter will be removed from the method's signature or will be added
		 * to the parameter object. The default is <code>false</code>. Changing the creatField
		 * property of the parameter object will throw a {@link IllegalArgumentException}
		 * 
		 * @param createField <code>true</code> if the parameter should be created as field,
		 *            <code>false</code> if it will remain in the method
		 */
		 ...
		 * {@link #isCreateField()} is <code>true</code>. Changing the fieldName of the parameter
		 * object will throw a {@link IllegalArgumentException}
		 * 
		 * @param fieldName the new name of the field. A <code>null</code> indicates that the field
		 *            name should be automatically derived
		 * @see #isCreateField()
		 */
	 ...
	 * @return an array of parameter corresponding to the parameter declared in the method. The
	 *         first object will be the parameter object. All parameter are marked for field
	 *         creation
	 */
	 ...
	 * <code>true</code>. Can be set using {@link #setPackageName(String)}. If the package name was
	 * <code>null</code> and the method has already been set this method returns the package where
	...
	/**
	 * Returns <code>true</code> if delegates will be marked as deprecated. Default is
	 * <code>false</code>.
	 * 
	 * @return <code>true</code> if delegates will be marked as deprecated. Default is
	 *         <code>false</code>
	 */
	...
	/**
	 * Sets the name of the class for the generated parameter object. The name can be
	 * <code>null</code> to indicate that the refactoring should chose one.
	 * 
	 * @param className the name of the generated class or <code>null</code>. Default is
	 *            <code>null</code>
	 */
	...
	/**
	 * Sets deprecate delegate. If <code>true</code> generated delegates will be marked as
	 * deprecated.
	 * 
	 * @param deprecateDelegate <code>true</code> to deprecate kept delegates. Default is
	 *            <code>false</code>
	 */
	...
	/**
	 * Sets the method. The method may not be <code>null</code>, has to exist, and has to be in a
	 * Java project.
	 * 
	 ...
	 * be used.
	 * 
	 * @param packageName the package for the top level class or <code>null</code>. Default is
	 *            <code>null</code>.
	 */
	 ...
	 * 
	 * @param parameterName the name of the parameter or <code>null</code>. Default is
	 *            <code>null</code>.
	 */
	 ...
	 * the number of parameter of the method + 1. One element has to be the
	 * {@link #PARAMETER_OBJECT}. Each parameter may only appear once.
	 * 
	...
	/**
	 * Sets whether the parameter object class will be created as top level class. if
	 * <code>true</code> the class will be created as top level class in the package returned by
	 * {@link #getPackageName()}. If <code>false</code> the class will be created as as nested class
