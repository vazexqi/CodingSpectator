 ...
 * </p>
 * 
 * @author Mohsen Vakilian, nchen - Make the class not complain about missing attributes if the
 *         descriptor is generated by CodingSpectator.
 * 
 * @since 1.1
 * 
...
public final class UseSupertypeDescriptor extends JavaRefactoringDescriptor {
	...
	public UseSupertypeDescriptor(String project, String description, String comment, Map arguments, int flags) {
		...
		//CODINGSPECTATOR: Do not set the fields if the descriptor has been generated by CodingSpectator because it might not have all the required fields.
		if (!isCapturedByCodingSpectator()) {
	...
	protected void populateArgumentMap() {
		...
		//CODINGSPECTATOR: If the descriptor is generated by CodingSpectator, it might not have some of the attributes.
		if (!isCapturedByCodingSpectator()) {
