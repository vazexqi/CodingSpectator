...
public class CodeSnippetParser extends Parser implements EvaluationConstants {
	...
	/**
	 * In case emulating local variables, wrap the (recovered) statements inside a try statement so
	 * as to achieve local state commiting (copy local vars back to fields). The CSToCuMapper could
	 * not be used, since it could have interfered with the syntax recovery specific to code
	 * snippets.
	 */
	...
	protected void consumeStatementReturn() {
		...
		if ((this.hasRecoveredOnExpression
			...
			pushOnAstStack(new CodeSnippetReturnStatement(
					expression,
