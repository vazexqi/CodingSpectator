...
public interface ITrackedNodePosition {
	 ...
	 * before or after the rewrite is applied. <code>-1</code> is returned for removed nodes.
	 * 
	...
	/**
	 * Returns the original or modified length of the tracked node depending if called before or
	 * after the rewrite is applied. <code>-1</code> is returned for removed nodes.
	 * 
