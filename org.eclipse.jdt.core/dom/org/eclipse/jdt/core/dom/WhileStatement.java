...
public class WhileStatement extends Statement {
	...
	/**
	 * Creates a new unparented while statement node owned by the given AST. By default, the
	 ...
	 * body of a while statement (they may only appear within a block). However, the AST will allow
	 * a <code>VariableDeclarationStatement</code> as the body of a <code>WhileStatement</code>. To
	 * get something that will compile, be sure to embed the
