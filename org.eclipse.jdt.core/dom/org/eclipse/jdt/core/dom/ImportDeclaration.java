...
public class ImportDeclaration extends ASTNode {
	...
	/**
	 * Creates a new AST node for an import declaration owned by the given AST. The import
	 * declaration initially is a regular (non-static) single type import for an unspecified, but
	 * legal, Java type name.
	 * <p>
	 ...
	 * <p>
	 * For a regular on-demand import, this is the name of a package. For a static on-demand import,
	 * this is the qualified name of a type. For a regular single-type import, this is the qualified
	 * name of a type. For a static single-type import, this is the qualified name of a static
	 * member of a type.
	 * </p>
	 * 
	 ...
	 * 
	 * @return <code>true</code> if this is an on-demand import, and <code>false</code> if this is a
	 *         single type import
	 */
	 ...
	 * 
	 * @param onDemand <code>true</code> if this is an on-demand import, and <code>false</code> if
	 *            this is a single type import
	 */
	 ...
	 * 
	 * @return <code>true</code> if this is a static import, and <code>false</code> if this is a
	 *         regular import
	 ...
	 * 
	 * @param isStatic <code>true</code> if this is a static import, and <code>false</code> if this
	 *            is a regular import
	 * @exception UnsupportedOperationException if this operation is used in a JLS2 AST
	 * @since 3.1
	 */
	...
	/**
	 * Resolves and returns the binding for the package, type, field, or method named in this import
	 * declaration.
	 * <p>
	 * The name specified in a non-static single-type import can resolve to a type (only). The name
	 * specified in a non-static on-demand import can itself resolve to either a package or a type.
	 * For static imports (introduced in JLS3), the name specified in a static on-demand import can
	 * itself resolve to a type (only). The name specified in a static single import can resolve to
	 * a type, field, or method; in cases where the name could be resolved to more than one element
	 * with that name (for example, two methods both named "max", or a method and a field), this
	 * method returns one of the plausible bindings.
	 * </p>
	 * <p>
	 * Note that bindings are generally unavailable unless requested when the AST is being built.
	 * </p>
	 * 
	 * @return a package, type, field, or method binding, or <code>null</code> if the binding cannot
	 *         be resolved
	 */
