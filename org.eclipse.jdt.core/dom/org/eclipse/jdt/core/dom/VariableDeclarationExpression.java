 ...
 * <code>VariableDeclarationFragment</code>) into a single expression (<code>Expression</code>), all
 * sharing the same modifiers and base type. This type of node can be used as the initializer of a
 * <code>ForStatement</code>, or wrapped in an <code>ExpressionStatement</code> to form the
 * equivalent of a <code>VariableDeclarationStatement</code>.
 * </p>
 * For JLS2:
 * 
 * <pre>
...
public class VariableDeclarationExpression extends Expression {
	...
	/**
	 * The list of variable declaration fragments (element type: {@link VariableDeclarationFragment}
	 ...
	 * By default, the variable declaration has: no modifiers, an unspecified (but legal) type, and
	 * an empty list of variable declaration fragments (which is syntactically illegal).
	 * <p>
	...
	/**
	 * Returns the live list of variable declaration fragments in this expression. Adding and
