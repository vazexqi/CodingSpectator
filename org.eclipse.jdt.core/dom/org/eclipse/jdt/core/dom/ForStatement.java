 ...
 * </pre>
 * <p>
 * Note: When variables are declared in the initializer of a for statement such as "
 * <code>for (int a=1, b=2;;);</code>", they should be represented as a single
 * <code>VariableDeclarationExpression</code> with two fragments, rather than being split up into a
 * pair of expressions.
 * </p>
 * 
 * @since 2.0
...
public class ForStatement extends Statement {
	...
	/**
	 * The list of initializer expressions (element type: <code>Expression</code>). Defaults to an
	 * empty list.
	 */
	...
	/**
	 * The list of update expressions (element type: <code>Expression</code>). Defaults to an empty
	 * list.
	 */
	...
	/**
	 * Creates a new AST node for a for statement owned by the given AST. By default, there are no
	 ...
	 * <p>
	 * The list should consist of either a list of so called statement expressions (JLS2, 14.8), or
	 * a single <code>VariableDeclarationExpression</code>. Otherwise, the for statement would have
	 * no Java source equivalent.
	 * </p>
	 * 
	 * @return the live list of initializer expressions (element type: <code>Expression</code>)
	 */
	...
	/**
	 * Returns the condition expression of this for statement, or <code>null</code> if there is
	 * none.
	 * 
	 ...
	 * </p>
	 * 
	 * @return the live list of update expressions (element type: <code>Expression</code>)
	 */
	 ...
	 * body of a for statement (they may only appear within a block). However, the AST will allow a
	 * <code>VariableDeclarationStatement</code> as the body of a <code>ForStatement</code>. To get
