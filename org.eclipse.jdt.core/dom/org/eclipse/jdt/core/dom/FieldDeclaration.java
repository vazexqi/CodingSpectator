 ...
 * character of the initial modifier or type. The source range extends through the last character of
 * the final ";".
 * </p>
 * 
 * @since 2.0
...
public class FieldDeclaration extends BodyDeclaration {
	...
	/**
	 * Creates a new unparented field declaration statement node owned by the given AST. By default,
	 * the field declaration has: no modifiers, an unspecified (but legal) type, and an empty list
	 * of variable declaration fragments (which is syntactically illegal).
	 * <p>
	...
	/**
	 * Returns the live list of variable declaration fragments in this field declaration. Adding and
