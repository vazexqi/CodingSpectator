...
public class IfStatement extends Statement {
	...
	/**
	 * Creates a new unparented if statement node owned by the given AST. By default, the
	 * expresssion is unspecified, but legal, the then statement is an empty block, and there is no
	 * else statement.
	 * <p>
	 ...
	 * "then" part of an if statement (they may only appear within a block). However, the AST will
	 * allow a <code>VariableDeclarationStatement</code> as the thenStatement of a
	 * <code>IfStatement</code>. To get something that will compile, be sure to embed the
	...
	/**
	 * Returns the "else" part of this if statement, or <code>null</code> if this if statement has
	 * <b>no</b> "else" part.
	 * <p>
	 * Note that there is a subtle difference between having no else statement and having an empty
	 ...
	 * <code>"if(true){}"</code>) and having an empty block (as in "if(true){}else{}") or null
	 * statement (as in "if(true){}else;").
	 * </p>
	 * <p>
	 * Special note: The Java language does not allow a local variable declaration to appear as the
	 * "else" part of an if statement (they may only appear within a block). However, the AST will
	 * allow a <code>VariableDeclarationStatement</code> as the elseStatement of a
	 * <code>IfStatement</code>. To get something that will compile, be sure to embed the
	 * <code>VariableDeclarationStatement</code> inside a <code>Block</code>.
	 * </p>
	 * 
