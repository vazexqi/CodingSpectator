...
public class PostfixExpression extends Expression {
	...
	public static class Operator {
		...
		/**
		 * Returns the postfix operator corresponding to the given string, or <code>null</code> if
		 * none.
		 * <p>
	...
	/**
	 * Creates a new AST node for an postfix expression owned by the given AST. By default, the node
	 * has unspecified (but legal) operator and operand.
	 * 
