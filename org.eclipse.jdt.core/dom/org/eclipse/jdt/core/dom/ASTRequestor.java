 ...
 * <p>
 * {@link #acceptAST(ICompilationUnit, CompilationUnit) ASTRequestor.acceptAST} is called for each
 * of the compilation units passed to
 * {@link ASTParser#createASTs(ICompilationUnit[], String[], ASTRequestor, org.eclipse.core.runtime.IProgressMonitor)
 * ASTParser.createASTs}. After all the compilation units have been processed,
 * {@link #acceptBinding(String, IBinding) ASTRequestor.acceptBindings} is called for each of the
