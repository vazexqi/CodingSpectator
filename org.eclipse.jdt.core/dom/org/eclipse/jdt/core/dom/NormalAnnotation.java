...
public final class NormalAnnotation extends Annotation {
	...
	/**
	 * The list of member value pairs (element type: {@link MemberValuePair}). Defaults to an empty
	 * list.
	 */
	...
	/**
	 * Creates a new unparented normal annotation node owned by the given AST. By default, the
	 * annotation has an unspecified type name and an empty list of member value pairs.
	 * <p>
	...
	/**
	 * Returns the live list of member value pairs in this annotation. Adding and removing nodes
	 * from this list affects this node dynamically. All nodes in this list must be
	 * {@link MemberValuePair}s; attempts to add any other type of node will trigger an exception.
	 * 
	 * @return the live list of member value pairs in this annotation (element type:
