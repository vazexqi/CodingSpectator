...
/**
 * Descriptor for a child list property of an AST node. A child list property is one whose value is
 * a list of {@link ASTNode}.
 * 
...
public final class ChildListPropertyDescriptor extends StructuralPropertyDescriptor {
	...
	/**
	 * Creates a new child list property descriptor with the given property id. Note that this
