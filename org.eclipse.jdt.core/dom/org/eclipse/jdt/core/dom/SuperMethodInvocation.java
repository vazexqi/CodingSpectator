...
public class SuperMethodInvocation extends Expression {
	...
	/**
	 * Creates a new AST node for a "super" method invocation expression owned by the given AST. By
	 * default, no qualifier, no type arguments, an unspecified, but legal, method name, and an
	...
	/**
	 * Returns the qualifier of this "super" method invocation expression, or <code>null</code> if
	 * there is none.
	 * 
	...
	/**
	 * Returns true if the resolved return type has been inferred from the assignment context (JLS3
	 * 15.12.2.8), false otherwise.
	 * <p>
	 * This information is available only when bindings are requested when the AST is being built
	 * </p>
	 * .
	 * 
	 * @return true if the resolved return type has been inferred from the assignment context (JLS3
	 *         15.12.2.8), false otherwise
	 * @since 3.3
	 */
	...
	/**
	 * Returns the live ordered list of type arguments of this method invocation (added in JLS3
	 * API).
	 * 
	...
	/**
	 * Returns the live ordered list of argument expressions in this "super" method invocation
	 * expression.
	 * 
