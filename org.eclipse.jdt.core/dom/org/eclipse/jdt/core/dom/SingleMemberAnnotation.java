...
/**
 * Single member annotation node (added in JLS3 API). The single member annotation "@foo(bar)" is
 * equivalent to the normal annotation "@foo(value=bar)".
 * <p>
 * 
 * <pre>
...
public final class SingleMemberAnnotation extends Annotation {
	 ...
	 * annotation has an unspecified type name and an unspecified value.
	 * <p>
