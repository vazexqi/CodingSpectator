...
/**
 * AST node for a simple name. A simple name is an identifier other than a keyword, boolean literal
...
public class SimpleName extends Name {
	...
	/**
	 * Creates a new AST node for a simple name owned by the given AST. The new node has an
	 * unspecified, legal Java identifier.
	 * <p>
	...
	/**
	 * Sets the identifier of this node to the given value. The identifier should be legal according
	 * to the rules of the Java language. Note that keywords are not legal identifiers.
	 * <p>
	 * Note that the list of keywords may depend on the version of the language (determined when the
	 * AST object was created).
	 * </p>
	 * 
	...
	/**
	 * Returns whether this simple name represents a name that is being defined, as opposed to one
	 * being referenced. The following positions are considered ones where a name is defined:
	 * <ul>
	 * <li>The type name in a <code>TypeDeclaration</code> node.</li>
	 * <li>The method name in a <code>MethodDeclaration</code> node providing
	 * <code>isConstructor</code> is <code>false</code>.</li>
	 ...
	 * </ul>
	 * <p>
	 * Note that this is a convenience method that simply checks whether this node appears in the
	 * declaration position relative to its parent. It always returns <code>false</code> if this
	 * node is unparented.
	 * </p>
	 * 
