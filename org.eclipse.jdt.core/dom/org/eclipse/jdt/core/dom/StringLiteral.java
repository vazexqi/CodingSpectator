...
public class StringLiteral extends Expression {
	...
	/**
	 * The literal string, including quotes and escapes; defaults to the literal for the empty
	 * string.
	 */
	private String escapedValue= "\"\"";//$NON-NLS-1$

	/**
	 * Creates a new unparented string literal node owned by the given AST. By default, the string
	 * literal denotes the empty string.
	 * <p>
	...
	/**
	 * Returns the string value of this literal node to the given string literal token. The token is
	 * the sequence of characters that would appear in the source program, including enclosing
	 * double quotes and embedded escapes.
	 * 
	...
	/**
	 * Sets the string value of this literal node to the given string literal token. The token is
	 * the sequence of characters that would appear in the source program, including enclosing
	 * double quotes and embedded escapes. For example,
	 * <ul>
	 ...
	 * </p>
	 * <p>
	 * Note that this is a convenience method that converts from the stored string literal token
	 ...
	 * </p>
	 * <p>
	 * Note that this is a convenience method that converts to the stored string literal token
	 * acceptable to <code>setEscapedLiteral</code>.
	 * </p>
	 * 
