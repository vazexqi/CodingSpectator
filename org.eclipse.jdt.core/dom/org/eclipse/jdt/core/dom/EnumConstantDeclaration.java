 ...
 * character of the identifier. If there are class body declarations, the source range extends
 * through the last character of the last character of the "}" token following the body
 * declarations. If there are arguments but no class body declarations, the source range extends
 * through the last character of the ")" token following the arguments. If there are no arguments
 * and no class body declarations, the source range extends through the last character of the
 * identifier.
 * </p>
 * 
 * @since 3.1
...
public class EnumConstantDeclaration extends BodyDeclaration {
	...
	/**
	 * The constant name; lazily initialized; defaults to a unspecified, legal Java class
	 * identifier.
	 */
	...
	/**
	 * Creates a new AST node for an enumeration constants declaration owned by the given AST. By
	 * default, the enumeration constant has an unspecified, but legal, name; no javadoc; an empty
	 * list of modifiers and annotations; an empty list of arguments; and does not declare an
	 * anonymous class.
	 * <p>
	...
	/**
	 * Returns the live ordered list of argument expressions in this enumeration constant
	 * declaration. Note that an empty list of arguments is equivalent to not explicitly specifying
	 * arguments.
	 * 
	 * @return the live list of argument expressions (element type: <code>Expression</code>)
	 */
	...
	/**
	 * Returns the anonymous class declaration introduced by this enum constant declaration, if it
	 * has one.
	 * 
	...
	/**
	 * Sets whether this enum constant declaration declares an anonymous class (that is, has class
	 * body declarations).
	 * 
