...
/**
 * Method declaration AST node type. A method declaration is the union of a method declaration and a
 ...
 * token (method, no modifiers, type parameters), or the first character of the return type (method,
 * no modifiers, no type parameters), or the first character of the identifier (constructor, no
 * modifiers). The source range extends through the last character of the ";" token (if no body), or
 * the last character of the block (if body).
 * </p>
 * <p>
...
public class MethodDeclaration extends BodyDeclaration {
	...
	/**
	 * The parameter declarations (element type: <code>SingleVariableDeclaration</code>). Defaults
	 * to an empty list.
	 */
	...
	/**
	 * The return type. JLS2 behevior: lazily initialized; defaults to void. JLS3 behavior; lazily
	 * initialized; defaults to void; null allowed. Note that this field is ignored for constructor
	 * declarations.
	 */
	...
	/**
	 * The type paramters (element type: <code>TypeParameter</code>). Null in JLS2. Added in JLS3;
	...
	/**
	 * The number of array dimensions that appear after the parameters, rather than after the return
	 * type itself; defaults to 0.
	 * 
	 * @since 2.1
	 */
	...
	/**
	 * The list of thrown exception names (element type: <code>Name</code>). Defaults to an empty
	 * list.
	 */
	...
	/**
	 * Creates a new AST node for a method declaration owned by the given AST. By default, the
	 * declaration is for a method of an unspecified, but legal, name; no modifiers; no javadoc; no
	 * type parameters; void return type; no parameters; no array dimensions after the parameters;
	 ...
	 * 
	 * @return <code>true</code> if this is a constructor declaration, and <code>false</code> if
	 ...
	 * 
	 * @param isConstructor <code>true</code> for a constructor declaration, and <code>false</code>
	...
	/**
	 * Returns the live ordered list of type parameters of this method declaration (added in JLS3
	 * API). This list is non-empty for parameterized methods.
	 * 
	 * @return the live list of type parameters (element type: <code>TypeParameter</code>)
	...
	/**
	 * Returns the name of the method declared in this method declaration. For a constructor
	 * declaration, this should be the same as the name of the class.
	 * 
	...
	/**
	 * Sets the name of the method declared in this method declaration to the given name. For a
	 * constructor declaration, this should be the same as the name of the class.
	 * 
	 ...
	 * 
	 * @return the live list of method parameter declarations (element type:
	 ...
	 * The convenience method checks whether the last parameter is so marked.
	 * 
	 * @return <code>true</code> if this is a variable arity method declaration, and
	 ...
	 * 
	 * @return the live list of exception names (element type: <code>Name</code>)
	 */
	...
	/**
	 * Returns the return type of the method declared in this method declaration, exclusive of any
	 * extra array dimensions (JLS2 API only). This is one of the few places where the void type is
	 * meaningful.
	 * <p>
	 * Note that this child is not relevant for constructor declarations (although, it does still
	 * figure in subtree equality comparisons and visits), and is devoid of the binding information
	 ...
	 * @deprecated In the JLS3 API, this method is replaced by {@link #getReturnType2()}, which may
	 ...
	 * exclusive of any extra array dimensions (JLS2 API only). This is one of the few places where
	 * the void type is meaningful.
	 * <p>
	 * Note that this child is not relevant for constructor declarations (although it does still
	 * figure in subtree equality comparisons and visits).
	 * </p>
	 * 
	 ...
	 *                </ul>
	 * @exception UnsupportedOperationException if this operation is used in an AST later than JLS2
	 * @deprecated In the JLS3 API, this method is replaced by {@link #setReturnType2(Type)}, which
	...
	/**
	 * Returns the return type of the method declared in this method declaration, exclusive of any
	 * extra array dimensions (added in JLS3 API). This is one of the few places where the void type
	 * is meaningful.
	 * <p>
	 * Note that this child is not relevant for constructor declarations (although, if present, it
	 * does still figure in subtree equality comparisons and visits), and is devoid of the binding
	 * information ordinarily available. In the JLS2 API, the return type is mandatory. In the JLS3
	 * API, the return type is optional.
	 * </p>
	 * 
	...
	/**
	 * Sets the return type of the method declared in this method declaration to the given type,
	 * exclusive of any extra array dimensions (added in JLS3 API). This is one of the few places
	 * where the void type is meaningful.
	 * <p>
	 * Note that this child is not relevant for constructor declarations (although it does still
	 * figure in subtree equality comparisons and visits). In the JLS2 API, the return type is
	 * mandatory. In the JLS3 API, the return type is optional.
	 * </p>
	 * 
	 * @param type the new return type, possibly the void primitive type, or <code>null</code> if
	 *            none
	 * @exception UnsupportedOperationException if this operation is used in a JLS2 AST
	 * @exception IllegalArgumentException if:
	 *                <ul>
	...
	/**
	 * Returns the number of extra array dimensions over and above the explicitly-specified return
	 * type.
	 * <p>
	 * For example, <code>int foo()[][]</code> has a return type of <code>int</code> and two extra
	 * array dimensions; <code>int[][] foo()</code> has a return type of <code>int[][]</code> and
	 * zero extra array dimensions. The two constructs have different ASTs, even though there are
	 * really syntactic variants of the same method declaration.
	 * </p>
	 * 
	...
	/**
	 * Sets the number of extra array dimensions over and above the explicitly-specified return
	 * type.
	 * <p>
	 * For example, <code>int foo()[][]</code> is rendered as a return type of <code>int</code> with
	 * two extra array dimensions; <code>int[][] foo()</code> is rendered as a return type of
	 * <code>int[][]</code> with zero extra array dimensions. The two constructs have different
	 * ASTs, even though there are really syntactic variants of the same method declaration.
	 * </p>
	 * 
	...
	/**
	 * Returns the body of this method declaration, or <code>null</code> if this method has
	 * <b>no</b> body.
	 * <p>
	 ...
	 * <p>
	 * Note that there is a subtle difference between having no body (as in
	 * <code>"void foo();"</code>) and having an empty body (as in "void foo() {}"). Abstract
	 * methods, and methods declared in interfaces, have no body. Non-abstract methods, and all
	...
	/**
	 * Resolves and returns the binding for the method or constructor declared in this method or
	 * constructor declaration.
	 * <p>
