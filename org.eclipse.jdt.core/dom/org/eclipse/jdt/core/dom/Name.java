...
/**
 * Abstract base class for all AST nodes that represent names. There are exactly two kinds of name:
 * simple ones (<code>SimpleName</code>) and qualified ones (<code>QualifiedName</code>).
 * <p>
 * 
 * <pre>
 * Name:
...
public abstract class Name extends Expression implements IDocElement {
	...
	/**
	 * Approximate base size of an expression node instance in bytes, including object header and
	 * instance fields.
	 */
	 ...
	 * the result is the name's identifier. If the name is a qualified name, the result is the name
	 * of the qualifier (as computed by this method) followed by "." followed by the name's
	 * identifier.
	 * 
