 ...
 * the type is an array type or primitive type. The normal use is when the type is a simple or
 * parameterized type.
 * </p>
 * <p>
 ...
 * determine this. Clients should be prepared to handle either rather than make assumptions. (Note
 * also that the first form became possible as of JLS3; only the second form existed in JLS2 API.)
 * </p>
 * 
 * @since 3.1
...
public class QualifiedType extends Type {
	...
	/**
	 * The type node; lazily initialized; defaults to a type with an unspecfied, but legal, simple
	 * name.
	 */
	...
	/**
	 * Creates a new unparented node for a qualified type owned by the given AST. By default, an
	 * unspecified, but legal, qualifier and name.
	 * <p>
