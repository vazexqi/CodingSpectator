...
/**
 * This class is used by the JavaParserIndexer. When parsing the java file, the requestor recognizes
 * the java elements (methods, fields, ...) and add them to an index.
 */
