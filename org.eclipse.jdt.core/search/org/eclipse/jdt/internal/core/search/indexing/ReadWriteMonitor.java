...
/**
 * Monitor ensuring no more than one writer working concurrently. Multiple readers are allowed to
 * perform simultaneously.
 */
public class ReadWriteMonitor {

	/**
	 * <0 : writing (cannot go beyond -1, i.e one concurrent writer) =0 : idle >0 : reading (number
	...
	/**
	 * Only one writer at a time is allowed to perform Blocking only when already writing or
	 * reading.
	 */
	...
	/**
	 * When writing is over, all readers and possible writers are granted permission to restart
	 * concurrently
	 */
	 ...
	 * Use when writing changes is optional, otherwise call the individual methods. Returns false if
	 * multiple readers are accessing the index.
	 */
	 ...
	 * When writing is over, all readers are granted permissing to restart concurrently. This is the
	 * same as:
	 * 
	 * <pre>
