...
/**
 * Ant 1.5 compiler adapter for the Eclipse Java compiler. This adapter permits the Eclipse Java
 * compiler to be used with the <code>javac</code> task in Ant scripts. In order to use it, just set
 * the property <code>build.compiler</code> as follows:
 * <p>
...
public class JDTCompilerAdapter extends DefaultCompilerAdapter {
	...
	/**
	 * Modified from base class, Logs the compilation parameters, adds the files to compile and logs
	 * the &quot;niceSourceList&quot; Appends encoding information at the end of arguments
	 * 
	 * @param cmd the given command line
	 */
