...
public class InternalCompletionProposal extends CompletionProposal {
	...
	/**
	 * Unique key of the relevant package or type declaration in the context, or <code>null</code>
	...
	/**
	 * Signature of the method, field type, member type, relevant in the context, or
	 * <code>null</code> if none. Defaults to null.
	 */
	private char[] signature= null;

	/**
	 * Unique of the method, field type, member type, relevant in the context, or <code>null</code>
	 * if none. Defaults to null.
	 */
	...
	/**
	 * Modifier flags relevant in the context, or <code>Flags.AccDefault</code> if none. Defaults to
	 * <code>Flags.AccDefault</code>.
	 */
	private int flags= Flags.AccDefault;

	/**
	 * Completion flags relevant in the context, or <code>CompletionFlags.Default</code> if none.
