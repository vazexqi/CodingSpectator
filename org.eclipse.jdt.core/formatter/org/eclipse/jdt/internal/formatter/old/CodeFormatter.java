 ...
 * <li>Use the method <code>void format(aString)</code> on this instance to format
 * <code>aString</code>. It will return the formatted string.
 * </ul>
 * 
 * @deprecated
 */
public class CodeFormatter implements TerminalTokens, org.eclipse.jdt.core.ICodeFormatter {
	...
	public String format(String string, int indentLevel, int[] positions, String lineSeparator) {
		...
		newOptions.put(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_METHOD_INVOCATION,
				DefaultCodeFormatterConstants.createAlignmentValue(false, DefaultCodeFormatterConstants.WRAP_ONE_PER_LINE, DefaultCodeFormatterConstants.INDENT_BY_ONE));
		newOptions.put(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_QUALIFIED_ALLOCATION_EXPRESSION,
				DefaultCodeFormatterConstants.createAlignmentValue(false, DefaultCodeFormatterConstants.WRAP_ONE_PER_LINE, DefaultCodeFormatterConstants.INDENT_BY_ONE));
