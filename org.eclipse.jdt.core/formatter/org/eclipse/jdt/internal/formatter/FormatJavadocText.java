 ...
 * <p>
 * Text may be simple as <code>Line inside a javadoc comment block</code> or may be a html tag. Note
 * that to minimize memory footprint, only text positions are stored.
 * </p>
 * <p>
 * Simple text may have one or several lines. When it has several lines, the positions of the line
 * breaks are also stored in the {@link #separators} array.
 * </p>
 * <p>
 ...
 */
	 ...
	 * 
	 * @return <code>true</code> if the node is an html tag and has '/' before its name (e.g.
	 *         </bla>), <code>false</code> otherwise.
	 */
	 ...
	 * <p>
	 * A text in considered as immutable when it belongs to an immutable block or when it's an
	 * immutable html tag.
	 * </p>
	 * 
	 * @return <code>true</code> if the node is an immutable tag, <code>false</code> otherwise.
	...
	/**
	 * Returns whether the text at the given separator index position is after a separator tag or
	 * not.
	 * 
	 * @return <code>true</code> if the text is after a separator tag, <code>false</code> otherwise
	 *         or if the given index is out the range of the text separators.
	 */
