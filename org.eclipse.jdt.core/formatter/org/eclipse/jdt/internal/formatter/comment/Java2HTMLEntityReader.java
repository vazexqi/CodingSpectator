...
/**
 * <code>SubstitutionTextReader</code> that will substitute html entities for html symbols
 * encountered in the original text. Line breaks and whitespaces are preserved.
 * 
 * @since 3.0
 */
public class Java2HTMLEntityReader extends SubstitutionTextReader {
	...
	/**
	 * True if we have not yet seen a non-whitespace character on the current line.
	 */
