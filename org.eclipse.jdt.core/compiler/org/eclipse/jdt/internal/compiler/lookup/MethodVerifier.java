...
// See isMethodSubsignature() for parameter comparisons
	...
	/**
	 * Return true and report an incompatibleReturnType error if currentMethod's return type is
	 * strictly incompatible with inheritedMethod's, else return false and report an unchecked
	 * conversion warning. Do not call when areReturnTypesCompatible(currentMethod, inheritedMethod)
	 * returns true.
	 * 
