...
public class LookupEnvironment implements ProblemReasons, TypeConstants {
	...
	/**
	 * Ask the name environment for a type which corresponds to the compoundName. Answer null if the
...
//			return getResolvedType(JAVA_LANG_BOOLEAN, null);
	 ...
	 * @param forceRawEnclosingType forces recursive raw conversion of enclosing types (used in
	 *            Javadoc references only)
...
*/
	...
	/**
	 * Answer the type for the compoundName if it exists in the cache. Answer theNotFoundType if it
	 * could not be resolved the first time it was looked up, otherwise answer null.
	 * 
...
// The method verifier is lazily initialized to guarantee the receiver, the compiler & the oracle are ready.
	...
	/**
	 * Associate a given type with some access restriction (did not store the restriction directly
	 * into binding, since sparse information)
	 */
