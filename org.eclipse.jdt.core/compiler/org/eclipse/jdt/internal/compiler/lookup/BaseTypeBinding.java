...
public final class BaseTypeBinding extends TypeBinding {
	...
	/**
	 * Predicate telling whether "left" can store a "right" using some narrowing conversion (is left
	 * smaller than right)
	 * 
	...
	/**
	 * Predicate telling whether "left" can store a "right" using some widening conversion (is left
	 * bigger than right)
	 * 
	 * @param left - the target type to convert to
	 * @param right - the actual type
