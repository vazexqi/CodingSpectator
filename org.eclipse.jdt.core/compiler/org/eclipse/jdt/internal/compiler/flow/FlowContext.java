 ...
 */
	 ...
	 *            CAN_ONLY_NULL_NON_NULL}, {@link #MAY_NULL MAY_NULL}, {@link #CAN_ONLY_NON_NULL
	 *            CAN_ONLY_NON_NULL}, potentially combined with a context indicator (one of
	 *            {@link #IN_COMPARISON_NULL}, {@link #IN_COMPARISON_NON_NULL},
	 *            {@link #IN_ASSIGNMENT} or {@link #IN_INSTANCEOF})
	 */
	 ...
	 * checks; nonetheless, contexts that are nested into a looping or a finally context get
	 ...
	 * @param checkType the status against which the check must be performed; one of
	 *            {@link #CAN_ONLY_NULL CAN_ONLY_NULL}, {@link #CAN_ONLY_NULL_NON_NULL
	 *            CAN_ONLY_NULL_NON_NULL}, {@link #MAY_NULL MAY_NULL}, potentially combined with a
	 *            context indicator (one of {@link #IN_COMPARISON_NULL},
	 *            {@link #IN_COMPARISON_NON_NULL}, {@link #IN_ASSIGNMENT} or {@link #IN_INSTANCEOF})
	 * @param flowInfo the flow info at the check point; deferring contexts will perform
	 *            supplementary checks against flow info instances that cannot be known at the time
	 *            of calling this method (they are influenced by code that follows the current
	 *            point)
	 */
