...
/**
 * IMPORTANT NOTE: Internal Scanner implementation. It is mirrored in org.eclipse.jdt.core.compiler
 * public package where it is API. The mirror implementation is using the backward compatible
 * ITerminalSymbols constant definitions (stable with 2.0), whereas the internal implementation uses
 * TerminalTokens which constant values reflect the latest parser generation state.
 */
 ...
 */
	 ...
	 * 
	 * Line numbers are 1-based, and relative to the scanner initialPosition. Character positions
	 * are 0-based.
	 * 
