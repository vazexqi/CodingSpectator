...
public class FieldInfo extends ClassFileStruct implements IBinaryField, Comparable {
	...
	/**
	 * Return the constant of the field. Return
	 * org.eclipse.jdt.internal.compiler.impl.Constant.NotAConstant if there is none.
	 * 
	...
	/**
	 * Answer the resolved name of the receiver's type in the class file format as specified in
	 * section 4.3.2 of the Java 2 VM spec.
	 * 
	 * For example: - java.lang.String is Ljava/lang/String; - an int is I - a 2 dimensional array
	 * of strings is [[Ljava/lang/String; - an array of floats is [F
	 * 
	 * @return char[]
	 */
