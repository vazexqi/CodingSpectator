...
public class AnnotationInfo extends ClassFileStruct implements IBinaryAnnotation {
	 ...
	 * @param offset the offset into <code>classFileBytes</code> for the "type_index" of the
	...
	/**
	 * Read through this annotation in order to figure out the necessary tag bits and the length of
	 * this annotation. The data structure will not be flushed out.
	 * 
	 * The tag bits are derived from the following (supported) standard annotation.
	 * java.lang.annotation.Documented, java.lang.annotation.Retention, java.lang.annotation.Target,
	 * and java.lang.Deprecated
	 * 
