...
public class AccessRuleSet {
	 ...
	 *            {@link AccessRestriction#LIBRARY}, {@link AccessRestriction#PROJECT} that tells
	 *            the access restrictions how to render the classpath entry
	...
	/**
	 * Select the first access rule which is violated when accessing a given type, or null if no
