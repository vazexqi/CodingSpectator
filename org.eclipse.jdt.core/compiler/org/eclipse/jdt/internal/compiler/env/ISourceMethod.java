...
public interface ISourceMethod extends IGenericMethod {
	 ...
	 * 
	 * A name is a simple name or a qualified, dot separated name. For example, Hashtable or
	 * java.util.Hashtable.
	 */
	 ...
	 * 
	 * The name is a simple name or a qualified, dot separated name. For example, Hashtable or
	 * java.util.Hashtable.
	 */
	...
	/**
	 * Answer the array of bound names of the receiver's type parameters or null if the array is
	 * empty.
	 */
