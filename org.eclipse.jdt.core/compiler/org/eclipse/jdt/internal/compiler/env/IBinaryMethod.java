...
public interface IBinaryMethod extends IGenericMethod {
	...
	/**
	 * Answer the resolved names of the exception types in the class file format as specified in
	 * section 4.2 of the Java 2 VM spec or null if the array is empty.
	 * 
	 ...
	 * section 4.4.4 of the Java 2 VM spec.
	 */
	char[] getGenericSignature();

	/**
	 * Answer the receiver's method descriptor which describes the parameter & return types as
	 * specified in section 4.4.3 of the Java 2 VM spec.
	 * 
	 * For example: - int foo(String) is (Ljava/lang/String;)I - Object[] foo(int) is
	 * (I)[Ljava/lang/Object;
	 */
