...
//					}
	...
	/**
	 * Separates into a reusable method the subpart of {@link #resolveType(BlockScope)} that needs
	 * to be executed while climbing up the chain of expressions of this' leftmost branch. For use
	 * by {@link CombinedBinaryExpression#resolveType(BlockScope)}.
	 * 
