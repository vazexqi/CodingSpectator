...
/**
 * The <code>LRUCacheEnumerator</code> returns its elements in the order they are found in the
 * <code>LRUCache</code>, with the most recent elements first.
 * 
 * Once the enumerator is created, elements which are later added to the cache are not returned by
 * the enumerator. However, elements returned from the enumerator could have been closed by the
 * cache.
 */
