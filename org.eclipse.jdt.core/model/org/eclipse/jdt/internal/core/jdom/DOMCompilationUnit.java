...
class DOMCompilationUnit extends DOMNode implements IDOMCompilationUnit, SuffixConstants {
	...
	/**
	 * The comment and/or whitespace preceding the first document fragment in this compilation unit.
	 */
	 ...
	 *            range of this node within its document. A compilation unit's source range is the
	 *            entire document - the first integer is zero, and the second integer is the
	 *            position of the last character in the document.
	 */
