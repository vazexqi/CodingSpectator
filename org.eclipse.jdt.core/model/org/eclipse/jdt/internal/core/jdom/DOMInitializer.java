...
class DOMInitializer extends DOMMember implements IDOMInitializer {
	...
	/**
	 * The contents of the initializer's body when the body has been altered from the contents in
	 * the document, otherwise <code>null</code>.
	 */
	 ...
	 * @param bodyStartPosition - the position of the open brace of the body of this initialzer.
	 */
