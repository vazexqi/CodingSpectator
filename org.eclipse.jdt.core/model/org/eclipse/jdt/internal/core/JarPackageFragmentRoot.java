...
public class JarPackageFragmentRoot extends PackageFragmentRoot {
	...
	/**
	 * The path to the jar file (a workspace relative path if the jar is internal, or an OS path if
	 * the jar is external)
	 */
	 ...
	 * based on a JAR file that is not contained in a <code>IJavaProject</code> and does not have an
	 * associated <code>IResource</code>.
	 */
	...
	/**
	 * Compute the package fragment children of this package fragment root. These are all of the
	 * directory zip entries, and any directories implied by the path of class files contained in
	 * the jar of this package fragment root.
	 */
	...
	/**
	 * Returns true if this handle represents the same jar as the given handle. Two jars are equal
	 * if they share the same zip file.
	 * 
	 * @see Object#equals
	 */
