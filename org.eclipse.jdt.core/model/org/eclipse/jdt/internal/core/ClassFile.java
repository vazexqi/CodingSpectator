 ...
 */
	...
	/**
	 * Creates the children elements for this class file adding the resulting new handles and info
	 * objects to the newElements table. Returns true if successful, or false if an error is
	 * encountered parsing the class file.
	 * 
	 * @see Openable
	 * @see Signature
	 */
 ...
 */
	 ...
	 * <code>elt</elt>'s children (including <code>elt</code> itself) which has a source range that
	 * encloses <code>position</code> according to <code>mapper</code>.
	 */
	...
	/**
	 * Returns the <code>ClassFileReader</code>specific for this IClassFile, based on its underlying
	 * resource, or <code>null</code> if unable to create the diet class file. There are two cases
	 * to consider:
	 * <ul>
	 ...
	 * </ul>
	 * 
	 * @exception JavaModelException when the IFile resource or JAR is not available or when this
	 *                class file is not present in the JAR
	 */
 ...
 */
	...
	/**
	 * Opens and returns buffer on the source code associated with this class file. Maps the source
	 * code to the children elements of this class file. If no source code is associated with this
	 * class file, <code>null</code> is returned.
	 * 
	 * @see Openable
	 */
...
/* package */static String simpleName(char[] className) {
	...
	/**
	 * Returns the Java Model representation of the given name which is provided in diet class file
	 * format, or <code>null</code> if the given name is <code>null</code>.
	 * 
	 * <p>
	 * <code>ClassFileReader</code> format is similar to "java/lang/Object", and corresponding Java
	 * Model format is "java.lang.Object".
	 */
	...
	/**
	 * Returns the Java Model representation of the given names which are provided in diet class
	 * file format, or <code>null</code> if the given names are <code>null</code>.
	 * 
	 * <p>
	 * <code>ClassFileReader</code> format is similar to "java/lang/Object", and corresponding Java
	 * Model format is "java.lang.Object".
...
/* package */static char[][] translatedNames(char[][] names) {
	...
	/**
	 * Returns the Java Model format of the unqualified class name for the given className which is
	 * provided in diet class file format, or <code>null</code> if the given className is
	 * <code>null</code>. (This removes the package name, but not enclosing type names).
	 * 
	 * <p>
	 * <code>ClassFileReader</code> format is similar to "java/lang/Object", and corresponding Java
	 * Model simple name format is "Object".
	 */
	...
	public void codeComplete(int offset, final org.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
		...
		codeComplete(
				...
				new ICompletionRequestor() {
					...
					public void acceptField(char[] declaringTypePackageName, char[] declaringTypeName, char[] fieldName, char[] typePackageName, char[] typeName, char[] completionName, int modifiers,
					...
					public void acceptMethod(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector, char[][] parameterPackageNames, char[][] parameterTypeNames,
							char[][] parameterNames, char[] returnTypePackageName, char[] returnTypeName, char[] completionName, int modifiers, int completionStart, int completionEnd, int relevance) {
						// skip parameter names
						requestor.acceptMethod(declaringTypePackageName, declaringTypeName, selector, parameterPackageNames, parameterTypeNames, returnTypePackageName, returnTypeName, completionName,
								modifiers, completionStart, completionEnd);
					}

					public void acceptMethodDeclaration(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector, char[][] parameterPackageNames, char[][] parameterTypeNames,
							char[][] parameterNames, char[] returnTypePackageName, char[] returnTypeName, char[] completionName, int modifiers, int completionStart, int completionEnd, int relevance) {
						// ignore
					}
