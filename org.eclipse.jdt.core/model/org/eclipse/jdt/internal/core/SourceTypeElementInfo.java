...
public class SourceTypeElementInfo extends AnnotatableInfo implements ISourceType {
	...
	/**
	 * The name of the superclass for this type. This name is fully qualified for binary types and
	 * is NOT fully qualified for source types.
	 */
	protected char[] superclassName;

	/**
	 * The names of the interfaces this type implements or extends. These names are fully qualified
	 * in the case of a binary type, and are NOT fully qualified in the case of a source type
	 */
 ...
 */
	...
	/**
	 * Returns the ISourceType that is the enclosing type for this type, or <code>null</code> if
	 * this type is a top level type.
	 */
