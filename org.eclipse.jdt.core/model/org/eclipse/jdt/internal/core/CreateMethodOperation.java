...
public class CreateMethodOperation extends CreateTypeMemberOperation {
	...
	/**
	 * When executed, this operation will create a method in the given type with the specified
	 * source.
	 */
	...
	/**
	 * Returns the type signatures of the parameter types of the current
