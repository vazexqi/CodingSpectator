...
public class JavaElementDelta extends SimpleDelta implements IJavaElementDelta {
	...
	/**
	 * Creates the root delta. To create the nested delta hierarchies use the following convenience
	...
	/**
	 * Creates the nested deltas resulting from an add operation. Convenience method for creating
	 * add deltas. The constructor should be used to create the root delta and then an add operation
 ...
 */
	...
	/**
	 * Returns the <code>JavaElementDelta</code> for the given element in the delta tree, or null,
	...
	/**
	 * Creates the delta tree for the given element and delta, and then inserts the tree as an
	 * affected child of this node.
	 */
	...
	/**
	 * Creates the nested deltas resulting from an move operation. Convenience method for creating
	 * the "move from" delta. The constructor should be used to create the root delta and then the
	 * move operation should call this method.
	 */
	...
	/**
	 * Creates the nested deltas resulting from an move operation. Convenience method for creating
	 * the "move to" delta. The constructor should be used to create the root delta and then the
	 * move operation should call this method.
	 */
	...
	/**
	 * Creates the nested deltas resulting from an delete operation. Convenience method for creating
