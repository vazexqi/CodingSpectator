...
public class BuildNotifier {
	...
	/**
	 * Check whether the build has been canceled. Must use this call instead of checkCancel() when
	 * within the compiler.
	 */
	...
	/**
	 * Sets the cancelling flag, which indicates we are in the middle of being cancelled. Certain
	 * places (those callable indirectly from the compiler) should not check cancel again while this
	 * is true, to avoid OperationCanceledException being thrown at an inopportune time.
	 */
	...
	/**
	 * Update the problem counts from one compilation result given the old and new problems, either
