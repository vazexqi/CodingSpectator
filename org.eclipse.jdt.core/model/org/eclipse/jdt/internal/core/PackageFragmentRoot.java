 ...
 */
	 ...
	 * 
	 * @exception JavaModelException The resource associated with this package fragment root does
	 *                not exist
	 */
	 ...
	 * 
	 * @exception JavaModelException The resource associated with this package fragment does not
	 *                exist
	 */
	protected void computeFolderChildren(IContainer folder, boolean isIncluded, String[] pkgName, ArrayList vChildren, char[][] inclusionPatterns, char[][] exclusionPatterns)
			throws JavaModelException {
 ...
 */
	...
	/**
	 * Returns the root's kind - K_SOURCE or K_BINARY, defaults to K_SOURCE if it is not on the
	 * classpath.
	 * 
	 * @exception JavaModelException if the project and root do not exist.
	 */
	...
	/**
	 * Compares two objects for equality; for <code>PackageFragmentRoot</code>s, equality is having
	 * the same parent, same resources, and occurrence count.
	 * 
	 */
 ...
 */
	...
	/**
	 * For use by <code>AttachSourceOperation</code> only. Sets the source mapper associated with
	 * this root.
	 */
