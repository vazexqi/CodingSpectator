...
/**
 * <p>
 * This operation adds/replaces a package declaration in an existing compilation unit. If the
 * compilation unit already includes the specified package declaration, it is not generated (it does
...
public class CreatePackageDeclarationOperation extends CreateElementInCUOperation {
	 ...
	 * <li>INVALID_NAME - a name supplied to the operation was not a valid package declaration name.
	 * </ul>
	 * 
