...
/**
 * <p>
 * This operation creates a compilation unit (CU). If the CU doesn't exist yet, a new compilation
 * unit will be created with the content provided. Otherwise the operation will override the
 * contents of an existing CU with the new content.
 * 
 * <p>
 ...
 * <li>The name of the compilation unit. Do not include the <code>".java"</code> suffix (ex.
 * <code>"Object"</code> - the <code>".java"</code> will be added for the name of the compilation
 * unit.)
 * <li>
 * </ul>
 */
public class CreateCompilationUnitOperation extends JavaModelOperation {
	 ...
	 * <code>null</code>.
	 * <li>INVALID_NAME - the compilation unit name provided to the operation is <code>null</code>
