...
/**
 * This operation deletes a collection of resources and all of their children. It does not delete
 * resources which do not belong to the Java Model (eg GIF files).
 */
public class DeleteResourceElementsOperation extends MultiOperation {
	 ...
	 * be <code>null</code> or empty, and must have a corresponding resource.
	 */
