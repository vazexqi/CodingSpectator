...
/**
 * The <code>LRUCache</code> is a hashtable that stores a finite number of elements. When an attempt
 * is made to add values to a full cache, the least recently used values in the cache are discarded
 * to make room for the new values as necessary.
 * 
 * <p>
