...
public abstract class SourceMethodElementInfo extends AnnotatableInfo implements ISourceMethod {
	...
	/**
	 * For a source method (that is, a method contained in a compilation unit) this is a collection
	 * of the names of the parameters for this method, in the order the parameters are delcared. For
	 * a binary method (that is, a method declared in a binary type), these names are invented as
	 * "arg"i where i starts at 1. This is an empty array if this method has no parameters.
	 */
	protected char[][] argumentNames;

	/**
	 * A collection of type names of the exceptions this method throws, or an empty collection if
	 * this method does not declare to throw any exceptions. A name is a simple name or a qualified,
