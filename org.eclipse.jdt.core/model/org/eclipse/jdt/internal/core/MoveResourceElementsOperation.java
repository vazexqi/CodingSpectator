 ...
 * container to a specified destination container, optionally renaming the elements. A move resource
 * operation is equivalent to a copy resource operation, where the source resources are deleted
 * after the copy.
 * <p>
