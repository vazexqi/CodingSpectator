...
/**
 * The <code>OverflowingLRUCache</code> is an LRUCache which attempts to maintain a size equal or
 * less than its <code>fSpaceLimit</code> by removing the least recently used elements.
 * 
 * <p>
 ...
 * <code>fSpaceLimit</code>. Later, it will attempt to shink back to the maximum space limit.
 * 
 * The method <code>close</code> should attempt to close the element. If the element is successfully
 ...
 * 
 * <p>
 * Use the <code>#peek(Object)</code> and <code>#disableTimestamps()</code> method to circumvent the
 ...
 * <code>#peek(Object)</code> instead of <code>#get(Object)</code> method.
 * 
 * @see LRUCache
 */
public abstract class OverflowingLRUCache extends LRUCache {
	 ...
	 * element it is trying to remove (or will close it promptly).
	 * 
