...
/**
 * This class is intended to be subclassed to disassemble classfile bytes onto a String using the
...
public abstract class ClassFileBytesDisassembler {
	...
	/**
	 * The mode is the detailed mode to disassemble IClassFileReader. It returns the magic numbers,
	 * the version numbers and field and method descriptors.
	 */
	...
	/**
	 * This mode corresponds to the detailed mode plus the constant pool contents and any further
	 * information that would be useful for debugging purpose.
	 * 
	 * @since 3.1
	 */
	...
	/**
	 * Answers back the disassembled string of the classfile bytes using the default mode. This is
	 * an output quite similar to the javap tool, using DEFAULT mode.
	 * 
	...
	/**
	 * Answers back the disassembled string of the classfile bytes according to the mode. This is an
	 * output quite similar to the javap tool.
	 * 
	 * @param classFileBytes The bytes of the classfile
	 * @param lineSeparator the line separator to use.
