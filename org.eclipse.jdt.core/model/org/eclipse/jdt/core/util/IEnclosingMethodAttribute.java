...
/**
 * Description of an enclosing method attribute as described in the JVM specifications (added in
 * J2SE 1.5).
 * 
...
public interface IEnclosingMethodAttribute extends IClassFileAttribute {
	 ...
	 * 
	 * @return the enclosing class name as specified in the JVM specifications
	 */
	...
	/**
	 * Answer back the method descriptor of the enclosing method as specified in the JVM
	 * specifications.
	 * 
	 * @return the method descriptor of the enclosing method as specified in the JVM specifications
	 */
	 ...
	 * 
	 * @return the name of the enclosing method as specified in the JVM specifications
	 */
	char[] getMethodName();
