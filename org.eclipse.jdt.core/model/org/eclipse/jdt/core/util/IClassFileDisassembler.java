...
/**
 * This interface is intended to be implemented to disassemble IClassFileReader onto a String using
 * the proper line separator.
 * 
 * @since 2.0
...
public interface IClassFileDisassembler {
	...
	/**
	 * Answers back the disassembled string of the IClassFileReader using the default mode. This is
