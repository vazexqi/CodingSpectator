...
public interface IInnerClassesAttribute extends IClassFileAttribute {
	 ...
	 * 
	 * @return the number of inner classes infos as specified in the JVM specifications
	 */
	int getNumberOfClasses();

	/**
	 * Answer back the array of inner attribute entries as specified in the JVM specifications, or
	 * an empty array if none.
	 * 
	 * @return the array of inner attribute entries as specified in the JVM specifications, or an
	 *         empty array if none
	 */
