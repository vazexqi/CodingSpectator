...
/**
 * Description of a .class file. This class reifies the internal structure of a .class file
 * following the JVM specifications.
 * <p>
 * Note that several changes were introduced with J2SE 1.5. Class file reader implementations should
 * use support these new class file attributes by returning objects implementing the appropriate
 * specialized attribute interfaces. Class file reader clients can search for these new attributes
...
public interface IClassFileReader {
	...
	/**
	 * This value should be used to read the constant pool entries and the method infos of a .class
	 * file.
	 */
	int METHOD_INFOS= 0x0002 + CONSTANT_POOL;

	/**
	 * This value should be used to read the constant pool entries and the field infos of a .class
	 * file.
	 */
	int FIELD_INFOS= 0x0004 + CONSTANT_POOL;

	/**
	 * This value should be used to read the constant pool entries and the super interface names of
	 * a .class file.
	 */
	int SUPER_INTERFACES= 0x0008 + CONSTANT_POOL;

	/**
	 * This value should be used to read the constant pool entries and the attributes of a .class
	 * file.
	 */
	...
	/**
	 * This value should be used to read the whole contents of the .class file except the method
	 * bodies.
	 */
	 ...
	 * The names are returned as described in the JVM specifications.
	 * 
	...
	/**
	 * Answer back the indexes in the constant pool of interfaces implemented by this .class file,
	 * an empty array if none.
	 * 
	 * @return the indexes in the constant pool of interfaces implemented by this .class file, an
	 *         empty array if none
	 */
	 ...
	 * 
	 * @return the array of method infos of this .class file, an empty array if none
	 */
	IMethodInfo[] getMethodInfos();

	/**
	 * Answer back the qualified name of the .class file. The name is returned as described in the
	 * JVM specifications.
	 * 
	...
	/**
	 * Answer back the qualified name of the superclass of this .class file. The name is returned as
	 * described in the JVM specifications. Answer null if getSuperclassIndex() is zero.
	 * 
	 * @return the qualified name of the superclass of this .class file, null if
	 *         getSuperclassIndex() is zero
	 */
	char[] getSuperclassName();

	/**
	 * Answer back the index of the superclass name in the constant pool of the .class file. Answer
	 * 0 if this .class file represents java.lang.Object.
	 * 
	 * @return the index of the superclass name in the constant pool of the .class file, 0 if this
	...
	/**
	 * Answer back the collection of all attributes of the field info. It includes
	 * SyntheticAttribute, ConstantValueAttributes, etc. Answers an empty array if none.
	 * 
	 * @return the collection of all attributes of the field info. It includes SyntheticAttribute,
	 *         ConstantValueAttributes, etc. Answers an empty array if none
	 */
