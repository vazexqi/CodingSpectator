...
public interface ILocalVariableAttribute extends IClassFileAttribute {
	...
	/**
	 * Answer back the local variable table length of this entry as specified in the JVM
	 * specifications.
	 * 
	 * @return the local variable table length of this entry as specified in the JVM specifications
	 */
	 ...
	 * 
	 * @return the local variable table of this entry as specified in the JVM specifications. Answer
