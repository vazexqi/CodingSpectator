...
public interface IVerificationTypeInfo {
	...
	/**
	 * Answer back the constant pool index of this verification type info as described in the JVM
	 * specifications. This makes sense only if the tag is 7.
	 * 
	 * @return the constant pool index of this verification type info as described in the JVM
	 *         specifications
	 * @since 3.0
	 */
	...
	/**
	 * Answer back the name of the class type referenced by the index in the constant pool as
	 * described in the JVM specifications. This makes sense only if the tag is 7.
	 * 
	 * @return the name of the class type referenced by the index in the constant pool as described
