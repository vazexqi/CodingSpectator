...
/**
 * Description of an annotation component value as described in the JVM specifications (added in
 * J2SE 1.5).
 * 
...
public interface IAnnotationComponentValue {
	...
	/**
	 * Returns the annotation component values as described in the JVM specifications if the tag
	 * item is '['. Returns null otherwise.
	 * 
	...
	/**
	 * Returns the class info as described in the JVM specifications if the tag item is 'c'. Returns
	 * null otherwise.
	 * 
	...
	/**
	 * Returns the constant value as described in the JVM specifications if the tag item is one of
	 * 'B', 'C', 'D', 'F', 'I', 'J', 'S', 'Z', or 's'. Returns null otherwise.
	 * 
	...
	/**
	 * Returns the constant value index as described in the JVM specifications if the tag item is
	 * one of 'B', 'C', 'D', 'F', 'I', 'J', 'S', 'Z', or 's'. The value is unspecified otherwise.
	 * 
	...
	/**
	 * Returns the simple name of the enum constant represented by this annotation component value
	 * as described in the JVM specifications if the tag item is 'e'. Returns null otherwise.
	 * 
	...
	/**
	 * Returns the utf8 constant index as described in the JVM specifications if the tag item is
	 * 'e'. The value is unspecified otherwise.
	 * 
	...
	/**
	 * Returns the binary name of the type of the enum constant represented by this annotation
	 * component value as described in the JVM specifications if the tag item is 'e'. Returns null
	 * otherwise.
	 * 
	 * @return the enum constant
	 * @since 3.1
