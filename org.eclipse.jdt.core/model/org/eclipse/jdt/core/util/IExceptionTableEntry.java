...
/**
 * The class represents an entry in the exception table of a ICodeAttribute as specified in the JVM
 * specifications.
 * 
...
public interface IExceptionTableEntry {
	...
	/**
	 * Answer back the catch type name, null if getCatchTypeIndex() returns 0. This is the case for
	 * any exception handler.
	 * 
	 * @return the catch type name, null if getCatchTypeIndex() returns 0. This is the case for any
	 *         exception handler
	 */
	char[] getCatchType();
}
