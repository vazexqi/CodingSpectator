...
/**
 * Description of a Java opcodes visitor. This should be used to walk the opcodes of a
 * ICodeAttribute.
 * 
 * Clients must subclass {@link ByteCodeVisitorAdapter} to define an implementation of this
 * interface.
 * 
 * @since 2.0
