...
public interface ICodeAttribute extends IClassFileAttribute {
	 ...
	 * 
	 * @return the array of exception entries, if they are present. An empty array otherwise
	 */
	IExceptionTableEntry[] getExceptionTable();

	/**
	 * Answer back the array of bytes, which represents all the opcodes as described in the JVM
	 * specifications.
	 * 
	 * @return the array of bytes, which represents all the opcodes as described in the JVM
	 *         specifications
	 */
	byte[] getBytecodes();
	 ...
	 * LineNumberAttribute and the LocalVariableTableAttribute. Returns an empty collection if none.
	 * 
	 * @return the collection of all attributes of the field info. It includes the
	 *         LineNumberAttribute and the LocalVariableTableAttribute. Returns an empty collection
	 *         if none
	 */
