...
/**
 * Represents an import declaration. The corresponding syntactic unit is ImportDeclaration (JLS2
 * 7.5). An import has no children and its parent is a compilation unit.
 * 
...
public interface IDOMImport extends IDOMNode {
	/**
	 * The <code>IDOMImport</code> refinement of this <code>IDOMNode</code> method returns the name
	 * of this import. The syntax for an import name corresponds to a fully qualified type name, or
	 * to an on-demand package name as defined by ImportDeclaration (JLS2 7.5).
	 * 
	...
	/**
	 * The <code>IDOMImport</code> refinement of this <code>IDOMNode</code> method sets the name of
	 * this import. The syntax for an import name corresponds to a fully qualified type name, or to
	 * an on-demand package name as defined by ImportDeclaration (JLS2 7.5).
	 * 
