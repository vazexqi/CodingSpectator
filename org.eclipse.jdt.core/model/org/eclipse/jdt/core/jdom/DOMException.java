...
/**
 * Unchecked exception thrown when an illegal manipulation of the JDOM is performed, or when an
 * attempt is made to access/set an attribute of a JDOM node that source indexes cannot be
 * determined for (in case the source was syntactically incorrect).
 * 
