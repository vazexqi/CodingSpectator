 ...
 * </p>
 * <p>
 * Note that the numeric values of these flags match the ones for class files as described in the
 * Java Virtual Machine Specification. The AST class <code>Modifier</code> provides the same
 * functionality as this class, only in the <code>org.eclipse.jdt.core.dom</code> package.
 * </p>
 * 
...
public final class Flags {
	...
	/**
	 * Returns whether the given integer does not include one of the <code>public</code>,
	 * <code>private</code>, or <code>protected</code> flags.
	 * 
	 * @param flags the flags
