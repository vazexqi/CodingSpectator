...
public interface IProblemRequestor {
	...
	/**
	 * Notification sent after having completed problem detection process. Typically, this would
	 * tell a problem collector that no more problems should be expected in this iteration.
	 */
	void endReporting();

	/**
	 * Predicate allowing the problem requestor to signal whether or not it is currently interested
	 * by problem reports. When answering <code>false</code>, problem will not be discovered any
	 * more until the next iteration.
	 * 
