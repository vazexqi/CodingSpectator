...
public class CompletionProposal {
	 ...
	 * <p>
	 * The following additional context information is available for this kind of completion
	 * proposal at little extra cost:
	 * <ul>
	...
	/**
	 * Completion is a reference to a local variable. This kind of completion might occur in a
	 * context like <code>"ke^ = 4;"</code> and complete it to <code>"keys = 4;"</code>.
	 * <p>
	 * The following additional context information is available for this kind of completion
	 * proposal at little extra cost:
	 * <ul>
	...
	/**
	 * Completion is a declaration of a method. This kind of completion might occur in a context
	 * like <code>"new List() {si^};"</code> and complete it to
	 ...
	 * <li>{@link #getName()} - the simple name of the method that is being overridden or
	 * implemented</li>
	 ...
	 * reference types, array types, parameterized types, and type variables. This kind of
	 * completion might occur in a context like <code>"public static Str^ key;"</code> and complete
	 * it to <code>"public static String key;"</code>.
	 * <p>
	 * The following additional context information is available for this kind of completion
	 * proposal at little extra cost:
	 * <ul>
	...
	/**
	 * Completion is a declaration of a new potential method. This kind of completion might occur in
	 * a context like <code>"new List() {si^};"</code> and complete it to
	 ...
	 * proposal at little extra cost:
	 * <ul>
	 * <li>{@link #getDeclarationSignature()} - the type signature of the annotation that declares
	 * the attribute that is referenced</li>
	...
	/**
	 * Completion is an import of reference to a type. Only reference to reference types are
	 * allowed.
	 * <p>
	 * The following additional context information is available for this kind of completion
	 * proposal at little extra cost:
	 ...
	 * <li>{@link #getFlags()} - the modifiers flags of the method that is referenced</li>
	 * <li>{@link #getName()} - the simple name of the method that is referenced</li>
	 * <li>{@link #getReceiverSignature()} - the type signature of the receiver type. It's the type
	 ...
	 * completion operation is called with a {@link IProgressMonitor} (eg.
	...
	/**
	 * Completion is a reference of a constructor of an anonymous class. This kind of completion
	 * might occur in a context like <code>"new Lis^;"</code> and complete it to
	...
	/**
	 * Returns the completion flags relevant in the context, or <code>CompletionFlags.Default</code>
	 * if none.
	 * <p>
	 ...
	 * Completion flags for this proposal kind can only include
	 * <code>CompletionFlags.StaticImport</code></li>
	 * <li><code>TYPE_IMPORT</code> - completion flags of the attribute that is referenced.
	 * Completion flags for this proposal kind can only include
	 * <code>CompletionFlags.StaticImport</code></li>
	 * </ul>
	 ...
	 * </p>
	 * 
	 * @return the kind; one of the kind constants declared on this class, or possibly a kind
	 ...
	 * offset is not within or immediately after an identifier or keyword, then the position
	 * returned is original request offset and the token range is empty.
	 * 
	 ...
	 * within or immediately after an identifier or keyword, then the source range begins at
	 ...
	 * <code>getReplaceEnd() == getReplaceStart()</code>), the completion string is to be inserted
	 * at this index.
	 * <p>
	...
	/**
	 * Returns the character index of the end of the subrange in the source file buffer to be
	 * replaced by the completion string. If the subrange is empty (
	 * <code>getReplaceEnd() == getReplaceStart()</code>), the completion string is to be inserted
	 * at this index.
	 * 
	 ...
	 * referenced</li>
	 * <li><code>FIELD_REF_WITH_CASTED_RECEIVER</code> - type signature of the type that declares
	 ...
	 * referenced</li>
	 * <li><code>METHOD_REF_WITH_CASTED_RECEIVER</code> - type signature of the type that declares
	 * the method that is referenced</li>
	 * <li><code>METHOD_DECLARATION</code> - type signature of the type that declares the method
	 ...
	 * </p>
	 * 
	 * @param name the keyword, field, method, local variable, or member name, or <code>null</code>
	 *            if none
	 */
	 ...
	 * <li><code>FIELD_REF_WITH_CASTED_RECEIVER</code> - the type signature of the referenced
	 * field's type</li>
	 ...
	 * referenced</li>
	 * <li><code>METHOD_DECLARATION</code> - method signature of the method that is being
	 * implemented or overridden</li>
	 ...
	 * This field is available for the following kinds of completion proposals:
	 * <ul>
	 * <li><code>ANNOTATION_ATTRIBUT_REF</code> - modifier flags of the attribute that is
	 * referenced;
	 ...
	 * <li><code>LOCAL_VARIABLE_REF</code> - modifier flags of the local variable that is referenced
	 * </li>
	 ...
	 * <code>Flags.AccAnnotation</code> can be used to recognize references to annotation type
	 * members</li>
	...
	/**
	 * Finds the method parameter names. This information is relevant to method reference (and
	 * method declaration proposals). Returns <code>null</code> if not available or not relevant.
	 * <p>
	 * The client must not modify the array returned.
	 * </p>
	 * <p>
