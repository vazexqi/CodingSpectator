...
/**
 * A buffer contains the text contents of a resource. It is not language-specific. The contents may
 * be in the process of being edited, differing from the actual contents of the underlying resource.
 * A buffer has an owner, which is an <code>IOpenable</code>. If a buffer does not have an
 * underlying resource, saving the buffer has no effect. Buffers can be read-only.
 * <p>
 * Note that java model operations that manipulate an <code>IBuffer</code> (for example,
 * <code>IType.createMethod(...)</code>) ensures that the same line delimiter (either
 ...
 * <code>IBuffer</code> might not do such transformations beforehand.
 * <p>
...
public interface IBuffer {
	...
	public interface ITextEditCapability {
		 ...
		 *             include:
		 *             <ul>
		 *             <li>The provided edit can not be applied as there is a problem with the text
		 *             edit locations ({@link IJavaModelStatusConstants#BAD_TEXT_EDIT_LOCATION})}.</li>
		 *             </ul>
		 */
