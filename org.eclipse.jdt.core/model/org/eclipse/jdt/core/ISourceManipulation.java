...
/**
 * Common protocol for Java elements that support source code manipulations such as copy, move,
 * rename, and delete.
 * 
...
public interface ISourceManipulation {
	 ...
	 *            <code>null</code> if the copy should be inserted as the last child of the
	 *            container
	 ...
	 *                <ul>
	 *                <li>This Java element, container element, or sibling does not exist
	 ...
	 *                <li>A child in the container already exists with the same name
	 *                (NAME_COLLISION) and <code>replace</code> has been specified as
	 *                <code>false</code>
	 ...
	 *            local file system will be tolerated (same as the force flag in IResource
	 *            operations).
	 * @param monitor a progress monitor
	 ...
	 *            <code>null</code> if the element should be inserted as the last child of the
	 *            container
