...
public interface ICodeCompletionRequestor {
	 ...
	 *            warnings are silently ignored. In case an error got signaled, no other completions
	 *            might be available, therefore the problem message should be presented to the user.
	 ...
	 *            during the code assist process). Note: the problem knows its originating file
	 *            name.
	 */
	 ...
	 * 
	 * @param parameterTypeNames Names of the parameters types. Should contain as many elements as
