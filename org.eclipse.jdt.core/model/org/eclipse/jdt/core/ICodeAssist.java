...
public interface ICodeAssist {
	...
	/**
	 * Performs code completion at the given offset position in this compilation unit, reporting
	 * results to the given completion requestor. The <code>offset</code> is the 0-based index of
	 * the character, after which code assist is desired. An <code>offset</code> of -1 indicates to
	 * code assist at the beginning of this compilation unit.
	 * 
	 ...
	 *                position specified is < -1 or is greater than this compilation unit's source
	 ...
	 * results to the given completion requestor. The <code>offset</code> is the 0-based index of
	 * the character, after which code assist is desired. An <code>offset</code> of -1 indicates to
	 * code assist at the beginning of this compilation unit. It considers types in the working
	 ...
	 * The <code>offset</code> is the 0-based index of the first selected character. The
	 ...
	 *                <ul>
	 *                <li>This Java element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
	 *                <li>The range specified is not within this element's source range
	 *                (INDEX_OUT_OF_BOUNDS)
	 *                </ul>
	 * 
	 */
