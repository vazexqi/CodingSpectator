...
/**
 * A completion requestor accepts results as they are computed and is aware of source positions to
 * complete the various different results.
 * <p>
...
public interface ICompletionRequestor {
	 ...
	 * 
	 * @param superTypePackageName Name of the package that contains the super type of this new
	 ...
	 *            parameterPackageNames.
	 * @param completionName The completion for the anonymous type declaration. Can include zero,
	 *            one or two brackets. If the closing bracket is included, then the cursor should be
	 *            placed before it.
	 * @param modifiers The modifiers of the constructor.
	 * @param completionStart The start position of insertion of the name of this new anonymous type
	 *            declaration.
	 * @param completionEnd The end position of insertion of the name of this new anonymous type
	 *            declaration.
	 * @param relevance The relevance of the completion proposal It is a positive integer which are
	 *            used for determine if this proposal is more relevant than another proposal. This
	 *            value can only be used for compare relevance. A proposal is more relevant than
	 *            another if his relevance value is higher.
	 * 
	 *            NOTE - All package and type names are presented in their readable form: Package
	 *            names are in the form "a.b.c". Base types are in the form "int" or "boolean".
	 *            Array types are in the qualified form "M[]" or "int[]". Nested type names are in
	 *            the qualified form "A.M". The default package is represented by an empty array.
	 * 
	 *            NOTE: parameter names can be retrieved from the source model after the user
	 ...
	 * 
	 *            NOTE - All package and type names are presented in their readable form: Package
	 *            names are in the form "a.b.c". Nested type names are in the qualified form "A.M".
	 ...
	 *            requestor, warnings are silently ignored. In case an error got signalled, no other
	 *            completions might be available, therefore the problem message should be presented
	 *            to the user. The source positions of the problem are related to the source where
	 *            it was detected (might be in another compilation unit, if it was indirectly
	 *            requested during the code assist process). Note: the problem knows its originating
	 *            file name.
	 * 
	 ...
	 * 
	 * @param declaringTypePackageName Name of the package in which the type that contains this
	 *            field is declared.
	 ...
	 * @param completionName The completion for the interface. Can include ';' for imported
	 *            interfaces.
	 ...
	 * @param typePackageName Name of the package in which the type of this new local variable is
	 *            declared.
	 * @param typeName Name of the type of this new local variable.
	 * @param modifiers The modifiers of this new local variable.
	 * @param completionStart The start position of insertion of the name of this new local
	 *            variable.
	 ...
	 * 
	 * @param declaringTypePackageName Name of the package in which the type that contains this new
	 *            method is declared.
	 ...
	 * @param returnTypeName Name of the return type of this new method, should be <code>null</code>
	 *            for a constructor.
	 * @param completionName The completion for the method. Can include zero, one or two brackets.
	 *            If the closing bracket is included, then the cursor should be placed before it.
	 ...
	 *            another if his relevance value is higher.
	 * 
	 *            NOTE - All package names are presented in their readable form: Package names are
	 *            in the form "a.b.c". The default package is represented by an empty array.
	 * @deprecated Use {@link CompletionRequestor#accept(CompletionProposal)} instead.
	 */
	void acceptPackage(
			char[] packageName,
