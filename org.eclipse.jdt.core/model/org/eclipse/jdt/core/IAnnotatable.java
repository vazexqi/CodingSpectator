...
public interface IAnnotatable {
	...
	/**
	 * Returns the annotation with the given name declared on this element. This is a handle-only
	 * method. The annotation may or may not exist.
	 * 
	...
	/**
	 * Returns the annotations for this element. Returns an empty array if this element has no
	 * annotations.
	 * 
	 * @exception JavaModelException if this element does not exist or if an exception occurs while
	 *                accessing its corresponding resource.
	 * @return the annotations of this element, in the order declared in the source, or an empty
	 *         array if none
	 * @since 3.4
	 */
